...
const COUNTRIES = [
  { code: "CA", name: "Canada",       currency: "CAD", locale: "en-CA", flag: "\u{1F1E8}\u{1F1E6}", entity: "Nutrition International HQ",  tz: "America/Toronto" },
  { code: "GB", name: "United Kingdom",currency: "GBP", locale: "en-GB", flag: "\u{1F1EC}\u{1F1E7}", entity: "NI UK Ltd",                   tz: "Europe/London" },
  { code: "IT", name: "Italy",        currency: "EUR", locale: "it-IT", flag: "\u{1F1EE}\u{1F1F9}", entity: "NI Italia Srl",                tz: "Europe/Rome" },
  { code: "CH", name: "Switzerland",  currency: "CHF", locale: "de-CH", flag: "\u{1F1E8}\u{1F1ED}", entity: "NI Suisse SA",                 tz: "Europe/Zurich" },
  { code: "MW", name: "Malawi",       currency: "MWK", locale: "en-MW", flag: "\u{1F1F2}\u{1F1FC}", entity: "NI Malawi",                    tz: "Africa/Blantyre" },
  { code: "KE", name: "Kenya",        currency: "KES", locale: "en-KE", flag: "\u{1F1F0}\u{1F1EA}", entity: "NI East Africa (Kenya)",       tz: "Africa/Nairobi" },
  { code: "NG", name: "Nigeria",      currency: "NGN", locale: "en-NG", flag: "\u{1F1F3}\u{1F1EC}", entity: "NI Nigeria",                   tz: "Africa/Lagos" },
  { code: "SN", name: "Senegal",      currency: "XOF", locale: "fr-SN", flag: "\u{1F1F8}\u{1F1F3}", entity: "NI S\u00e9n\u00e9gal",         tz: "Africa/Dakar" },
  { code: "TZ", name: "Tanzania",     currency: "TZS", locale: "en-TZ", flag: "\u{1F1F9}\u{1F1FF}", entity: "NI Tanzania",                  tz: "Africa/Dar_es_Salaam" },
  { code: "BD", name: "Bangladesh",   currency: "BDT", locale: "bn-BD", flag: "\u{1F1E7}\u{1F1E9}", entity: "NI Bangladesh",                tz: "Asia/Dhaka" },
  { code: "IN", name: "India",        currency: "INR", locale: "en-IN", flag: "\u{1F1EE}\u{1F1F3}", entity: "NI India Pvt Ltd",             tz: "Asia/Kolkata" },
  { code: "PK", name: "Pakistan",     currency: "PKR", locale: "en-PK", flag: "\u{1F1F5}\u{1F1F0}", entity: "NI Pakistan",                  tz: "Asia/Karachi" },
  { code: "ID", name: "Indonesia",    currency: "IDR", locale: "id-ID", flag: "\u{1F1EE}\u{1F1E9}", entity: "NI Indonesia",                 tz: "Asia/Jakarta" },
  { code: "PH", name: "Philippines",  currency: "PHP", locale: "en-PH", flag: "\u{1F1F5}\u{1F1ED}", entity: "NI Philippines",               tz: "Asia/Manila" },
];
