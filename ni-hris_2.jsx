...
// â”€â”€â”€ NI BRAND COLORS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const B = {
...
// â”€â”€â”€ ENTITIES / COUNTRIES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const COUNTRIES = [
  { code: "CA", name: "Canada", currency: "CAD", locale: "en-CA", flag: "ðŸ‡¨ðŸ‡¦", entity: "Nutrition International HQ", tz: "America/Toronto" },
  { code: "GB", name: "United Kingdom", currency: "GBP", locale: "en-GB", flag: "ðŸ‡¬ðŸ‡§", entity: "NI UK Ltd", tz: "Europe/London" },
  { code: "IT", name: "Italy", currency: "EUR", locale: "it-IT", flag: "ðŸ‡®ðŸ‡¹", entity: "NI Italia Srl", tz: "Europe/Rome" },
  { code: "CH", name: "Switzerland", currency: "CHF", locale: "de-CH", flag: "ðŸ‡¨ðŸ‡­", entity: "NI Suisse SA", tz: "Europe/Zurich" },
  { code: "MW", name: "Malawi", currency: "MWK", locale: "en-MW", flag: "ðŸ‡²ðŸ‡¼", entity: "NI Malawi", tz: "Africa/Blantyre" },
  { code: "KE", name: "Kenya", currency: "KES", locale: "en-KE", flag: "ðŸ‡°ðŸ‡ª", entity: "NI East Africa (Kenya)", tz: "Africa/Nairobi" },
  { code: "NG", name: "Nigeria", currency: "NGN", locale: "en-NG", flag: "ðŸ‡³ðŸ‡¬", entity: "NI Nigeria", tz: "Africa/Lagos" },
  { code: "SN", name: "Senegal", currency: "XOF", locale: "fr-SN", flag: "ðŸ‡¸ðŸ‡³", entity: "NI SÃ©nÃ©gal", tz: "Africa/Dakar" },
  { code: "TZ", name: "Tanzania", currency: "TZS", locale: "en-TZ", flag: "ðŸ‡¹ðŸ‡¿", entity: "NI Tanzania", tz: "Africa/Dar_es_Salaam" },
  { code: "BD", name: "Bangladesh", currency: "BDT", locale: "bn-BD", flag: "ðŸ‡§ðŸ‡©", entity: "NI Bangladesh", tz: "Asia/Dhaka" },
  { code: "IN", name: "India", currency: "INR", locale: "en-IN", flag: "ðŸ‡®ðŸ‡³", entity: "NI India Pvt Ltd", tz: "Asia/Kolkata" },
  { code: "PK", name: "Pakistan", currency: "PKR", locale: "en-PK", flag: "ðŸ‡µðŸ‡°", entity: "NI Pakistan", tz: "Asia/Karachi" },
  { code: "ID", name: "Indonesia", currency: "IDR", locale: "id-ID", flag: "ðŸ‡®ðŸ‡©", entity: "NI Indonesia", tz: "Asia/Jakarta" },
  { code: "PH", name: "Philippines", currency: "PHP", locale: "en-PH", flag: "ðŸ‡µðŸ‡­", entity: "NI Philippines", tz: "Asia/Manila" },
];
...
const LEAVE_TYPES = {
  ...
  IT: ["Ferie", "Malattia", "Congedo Parentale", "Permesso", "FestivitÃ "],
  CH: ["Ferien", "Krankheit", "Mutterschaftsurlaub", "MilitÃ¤rdienst", "Feiertage"],
  ...
  SN: ["CongÃ© Annuel", "CongÃ© Maladie", "CongÃ© MaternitÃ©", "Permission SpÃ©ciale", "Jours FÃ©riÃ©s"],
...
// â”€â”€â”€ NI EMPLOYMENT CLASSIFICATIONS (per Contracting at NI policy) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const CONTRACT_MODALITIES = [
  { code: "FT", label: "Fixed Term", duration: "3â€“12 months", nature: "Project-specific, seasonal", contractType: "Fixed Term FT/PT", benefits: "Flexibility, quick deployment" },
  ...
  { code: "EOR", label: "Employer of Record", duration: "1â€“3 years", nature: "All types (non-entity)", contractType: "Fixed Term or Permanent", benefits: "Legal compliance, taxes at source" },
  ...
  { code: "FIELD", label: "Field Staff Direct Hire", duration: "Daysâ€“1 year", nature: "Local field implementation", contractType: "Consultant", benefits: "Front-line field engagement" },
  { code: "SEC-IN", label: "Seconded to NI (via IP/Agency)", duration: "Daysâ€“1 year", nature: "Partner staff under NI supervision", contractType: "Secondment Agreement", benefits: "Integrated program delivery" },
  { code: "CON", label: "Consultant", duration: "Daysâ€“6 months", nature: "Specific deliverables", contractType: "Consultant", benefits: "Short-term expertise, no employment structure" },
...
const generateEmployees = () => {
  const names = [
    ...
    { first: "Fatima", last: "Al-Hassan", gender: "F" }, { first: "Lars", last: "MÃ¼ller", gender: "M" },
  ...
  return names.map((n, i) => {
    ...
    const employmentHistory = [
      { effectiveDate: hireDateStr, field: "Status", oldValue: "â€”", newValue: "Active", reason: "New Hire", changedBy: "System" },
      { effectiveDate: hireDateStr, field: "Title", oldValue: "â€”", newValue: isManager ? `${dept} Officer` : `${dept} Associate`, reason: "New Hire", changedBy: "System" },
      { effectiveDate: hireDateStr, field: "Level", oldValue: "â€”", newValue: prevLevel, reason: "New Hire", changedBy: "System" },
      { effectiveDate: hireDateStr, field: "Department", oldValue: "â€”", newValue: dept, reason: "New Hire", changedBy: "System" },
      { effectiveDate: hireDateStr, field: "Entity", oldValue: "â€”", newValue: country.entity, reason: "New Hire", changedBy: "System" },
      { effectiveDate: hireDateStr, field: "Compensation", oldValue: "â€”", newValue: Math.round(baseSalary * 0.86).toString(), reason: "New Hire", changedBy: "HR Admin" },
    ...
    const allowanceHistory = [
      { id: `AC-${i}-01`, type: "H&W", desc: "Gym membership (Janâ€“Mar)", amount: 135, date: "2025-03-15", status: "Reimbursed" },
      { id: `AC-${i}-02`, type: "L&D", desc: "Online certification course", amount: 450, date: "2025-04-20", status: "Reimbursed" },
      { id: `AC-${i}-03`, type: "H&W", desc: "Gym membership (Aprâ€“Jun)", amount: 135, date: "2025-06-15", status: "Reimbursed" },
...
const generateLeaveRequests = () => [
  ...
  { id: "LR-002", employeeId: "NI-01007", employeeName: "Lars MÃ¼ller", type: "Sick Leave", from: "2026-04-22", to: "2026-04-23", days: 2, status: "Approved", reason: "Medical appointment", country: "CH", submitted: "2026-04-21", approvedBy: "Sarah Chen", approvedDate: "2026-04-21" },
  ...
  { id: "LR-004", employeeId: "NI-01024", employeeName: "Amina Diallo", type: "CongÃ© Annuel", from: "2026-05-12", to: "2026-05-23", days: 10, status: "Pending", reason: "Retour au pays", country: "SN", submitted: "2026-04-18" },
...
const CASES = [
  { id: "CSE-001", employee: "NI-01000", subject: "Payslip discrepancy â€” March", category: "Payroll", status: "Open", priority: "High", created: "2026-04-18", sla: "2026-04-21", assignee: "People & Culture" },
  { id: "CSE-002", employee: "NI-01003", subject: "Visa renewal â€” Italy assignment", category: "Compliance", status: "In Progress", priority: "Critical", created: "2026-04-15", sla: "2026-04-20", assignee: "Global Mobility" },
...
const PENDING_APPROVALS = [
  { id: "APR-001", type: "Leave Request", employee: "Priya Patel", detail: "Annual Leave: Apr 28 â€“ May 2 (5 days)", submitted: "2026-04-20", urgency: "Normal" },
  { id: "APR-002", type: "H&W Allowance", employee: "Oliver Wright", detail: "Gym membership â€” Â£45/month", submitted: "2026-04-19", urgency: "Normal" },
  { id: "APR-003", type: "L&D Allowance", employee: "Mei Wong", detail: "Data Science course â€” CA$890", submitted: "2026-04-18", urgency: "Normal" },
  { id: "APR-004", type: "Comp Change", employee: "Joseph Mwangi", detail: "Salary: KES 180,000 â†’ KES 210,000", submitted: "2026-04-17", urgency: "High" },
  { id: "APR-005", type: "Leave Request", employee: "Amina Diallo", detail: "CongÃ© Annuel: May 12â€“23 (10 days)", submitted: "2026-04-18", urgency: "Normal" },
];
...
const fmtDate = (d) => { if (!d) return "â€”"; try { return new Date(d + "T00:00:00").toLocaleDateString("en-CA", { month: "short", day: "numeric", year: "numeric" }); } catch { return d; } };

// â”€â”€â”€ REUSABLE COMPONENTS (Premium Visual Design) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const MetricCard = ({ label, value, sub, color = B.accent, trend }) => (
  <Card style={{ minWidth: 0, position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
      ...
      {trend && <span style={{ fontSize: 11, fontWeight: 700, color: trend > 0 ? B.success : B.danger, background: trend > 0 ? B.successBg : B.dangerBg, padding: "1px 6px", borderRadius: 10 }}>{trend > 0 ? "â†‘" : "â†“"}{Math.abs(trend)}%</span>}
    </div>
...
// Photo storage (shared across the app) â€” stores { url, pos: { x, y, scale } }
const photoStore = {};
const usePhotos = () => {
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(37,55,70,0.5)", backdropFilter: "blur(3px)" }} onClick={onClose}>
      <div style={{ background: B.white, border: `1px solid ${B.border}`, borderRadius: 10, width: "92%", maxWidth: width, maxHeight: "85vh", overflow: "auto", padding: 24 }} onClick={e => e.stopPropagation()}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, paddingBottom: 14, borderBottom: `2px solid ${B.border}` }}>
          ...
          <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 18, color: B.textMuted, padding: 4 }}>âœ•</button>
        </div>
        {children}
      </div>
    </div>
...
// â”€â”€â”€ BATCH UPLOAD COMPONENT (Reusable) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const BatchUpload = ({ module, fields, sampleRows, onUpload, color = B.accent }) => {
  ...
  const handleDrop = (ev) => {
    ...
    if (files.length > 0) {
      ...
      setTimeout(() => {
        setMappedFields(fields.map((field, i) => ({ field, detected: field, confidence: Math.random() > 0.15 ? "High" : "Medium", sample: sampleRows[0]?.[i] || "â€”" })));
      }, 500);
    }
  };
    ...
    <div>
      ...
      {!uploaded && (
        <div onDragOver={ev => { ev.preventDefault(); setDragOver(true); }} onDragLeave={() => setDragOver(false)} onDrop={handleDrop}
          ...
          <div style={{ fontSize: 12, color: B.textMuted, marginTop: 4 }}>Accepts .xlsx, .csv, .tsv â€” headers will be auto-mapped to system fields</div>
      ...
      {uploaded && !validated && (
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 6, background: `${color}08`, border: `1px solid ${color}20`, marginBottom: 12 }}>
            ...
            <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>{uploaded.name}</div><div style={{ fontSize: 11, color: B.textMuted }}>{uploaded.type} Â· {uploaded.size}</div></div>
            <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={reset}>âœ• Remove</Btn>
          </div>
          {mappedFields && (
            <div>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                ...
                <Btn variant="primary" onClick={handleValidate} disabled={validating}>{validating ? "Validating..." : "âœ“ Validate & Preview"}</Btn>
              </div>
            </div>
          )}
        </div>
        ...
        <div>
          <div style={{ padding: 14, borderRadius: 8, background: B.successBg, border: `1px solid ${B.success}20`, marginBottom: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div><div style={{ fontSize: 13, fontWeight: 700, color: B.success }}>Validation Passed â€” Ready to Import</div>
                <div style={{ fontSize: 12, color: B.textSecondary }}>{uploaded.name} Â· {sampleRows.length} records detected Â· {mappedFields?.length} fields mapped Â· 0 errors, {Math.floor(Math.random() * 3)} warnings</div></div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
            <Btn variant="secondary" onClick={reset}>Start Over</Btn>
            <Btn variant="primary" onClick={() => { onUpload?.(sampleRows.length); reset(); }}>ðŸš€ Import {sampleRows.length} Records</Btn>
          </div>
        </div>
      )}
    </div>
...
// â”€â”€â”€ NI LOGO SVG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ CIRCLE-SQUARE BRAND ELEMENT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const AllowanceGauge = ({ label, used, total, color, icon }) => {
  ...
  return (
    <div style={{ background: B.white, border: `1px solid ${B.border}`, borderRadius: 12, padding: 16, display: "flex", gap: 14, alignItems: "center" }}>
      <svg width={68} height={68} viewBox="0 0 68 68" style={{ flexShrink: 0 }}>
        <circle cx={34} cy={34} r={r} fill="none" stroke={`${color}18`} strokeWidth={7} />
        <circle cx={34} cy={34} r={r} fill="none" stroke={color} strokeWidth={7} strokeDasharray={`${dash} ${circ - dash}`} strokeLinecap="round" transform="rotate(-90 34 34)" />
        <text x={34} y={31} textAnchor="middle" fontSize={13}>{icon}</text>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: B.textPrimary, fontFamily: "Georgia,serif" }}>CA${(total - used).toLocaleString()}</div>
        <div style={{ fontSize: 11, color: B.textMuted, marginBottom: 6 }}>remaining of CA${total.toLocaleString()}</div>
...
const LeavePill = ({ label, days, color, icon }) => (
  <div style={{ background: B.white, border: `1px solid ${B.border}`, borderRadius: 12, padding: "14px 16px", textAlign: "center", flex: 1, minWidth: 80 }}>
    ...
    <div style={{ fontSize: 10, color: B.textMuted }}>days</div>
  </div>
);
const EmployeeDashboard = ({ setModule }) => {
  const emp = ME;
  ...
  const myLearning = [
    ...
    { title: "Grant Compliance Fundamentals", progress: 45, modules: 6, color: B.blue },
    { title: "PSEA Mandatory Training", progress: 100, modules: 3, color: B.success },
  ];
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ borderRadius: 16, overflow: "hidden", position: "relative", background: `linear-gradient(135deg, ${B.charcoal} 0%, ${B.accent} 100%)`, padding: "28px 32px", boxShadow: "0 4px 24px rgba(37,55,70,0.18)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 18, flexWrap: "wrap" }}>
          <Avatar name={`${emp.first} ${emp.last}`} size={64} />
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginBottom: 4 }}>{dateStr}</div>
            <div style={{ fontSize: 26, fontWeight: 700, color: "#fff", fontFamily: "Georgia,serif", marginBottom: 4 }}>{greeting}, {emp.first}!</div>
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.7)" }}>{emp.title} · {emp.department} · {emp.flag} {emp.countryName} · {tenure}yr tenure</div>
          </div>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {[{ l: "Rating", v: `${emp.performanceRating}/5.0`, c: B.yellow }, { l: "Tenure", v: `${tenure} yrs`, c: B.ltTeal }, { l: "ID", v: emp.id, c: "rgba(255,255,255,0.65)" }].map((s,i)=>(
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 2, minWidth: 200, background: B.white, border: `1px solid ${B.border}`, borderRadius: 12, padding: "14px 18px" }}>
            <div style={{ fontSize: 11, color: B.textMuted, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 10 }}>Next Approved Leave</div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 8, background: B.successBg, border: `1px solid ${B.success}22` }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 700 }}>Annual Leave · 5 days</div>
                <div style={{ fontSize: 12, color: B.textMuted }}>Apr 28 – May 2 · Approved by {myMgr.first}</div>
              </div>
      ...
      <div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <AllowanceGauge label="Health and Wellness" used={emp.hwAllowance.used} total={emp.hwAllowance.total} color={B.teal} icon="💊" />
          <AllowanceGauge label="Learning and Development" used={emp.ldAllowance.used} total={emp.ldAllowance.total} color={B.blue} icon="🎓" />
        </div>
      </div>
        ...
        <Card>
          ...
          {myLearning.map((c,i)=>(
            <div key={i} style={{ marginBottom: 14 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}><span style={{ fontSize: 13, fontWeight: 600 }}>{c.title}</span><span style={{ fontSize: 12, fontWeight: 700, color: c.color }}>{c.progress}%</span></div>
              <ProgressBar value={c.progress} max={100} color={c.color} height={6} />
              <div style={{ fontSize: 11, color: B.textMuted, marginTop: 4 }}>{c.modules} modules</div>
            </div>
          ))}
        </Card>
          ...
          <Card>
            ...
            {whosOut.map((w,i)=>(
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: `1px solid ${B.borderLight}` }}>
                ...
                <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 600 }}>{w.emp.first} {w.emp.last}</div><div style={{ fontSize: 11, color: B.textMuted }}>{w.reason}</div></div>
          ...
          <Card>
            ...
            {celebrations.map((c,i)=>(
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: i<celebrations.length-1 ? `1px solid ${B.borderLight}` : "none" }}>
                ...
                <div><div style={{ fontSize: 12, fontWeight: 600 }}>{c.emp.first} {c.emp.last}</div><div style={{ fontSize: 11, color: B.textMuted }}>{c.type} · {c.date}</div></div>
              </div>
            ))}
          </Card>
        </div>
      ...
      <Card>
        ...
        {activity.map((a,i)=>(
          <div key={i} style={{ display: "flex", gap: 10, padding: "9px 0", borderBottom: i<activity.length-1 ? `1px solid ${B.borderLight}` : "none" }}>
            ...
            <div><div style={{ fontSize: 12, color: B.textPrimary, lineHeight: 1.5 }}>{a.text}</div><div style={{ fontSize: 10, color: B.textMuted, marginTop: 2 }}>{a.time}</div></div>
          </div>
        ))}
      </Card>
    </div>
      ...
      <div style={{ borderRadius: 16, background: `linear-gradient(135deg, ${B.dkBlue} 0%, ${B.blue} 100%)`, padding: "24px 28px", boxShadow: "0 4px 24px rgba(48,127,226,0.2)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.75)" }}>{mgr.title} · {team.length} direct reports · {PENDING_APPROVALS.length} pending approvals</div>
          </div>
        </div>
      </div>
        ...
        <Card>
          ...
          {PENDING_APPROVALS.slice(0,3).map(a=>(
            <div key={a.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 8, background: B.bgHover, marginBottom: 6 }}>
              ...
              <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 700 }}>{a.type}</div><div style={{ fontSize: 11, color: B.textMuted }}>{a.employee}</div></div>
              <div style={{ display: "flex", gap: 6 }}><Btn variant="success" size="sm">Approve</Btn><Btn variant="danger" size="sm">Deny</Btn></div>
            </div>
          ))}
        </Card>
        <Card>
          ...
          {team.slice(0,5).map(e=>(
            <div key={e.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: `1px solid ${B.borderLight}` }}>
              ...
              <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 600 }}>{e.first} {e.last}</div><div style={{ fontSize: 11, color: B.textMuted }}>{e.title}</div></div>
...
const DashboardModule = ({ setModule, role }) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        <Card><SectionTitle>Headcount by Country</SectionTitle>{countryCounts.slice(0,8).map(c=>(<div key={c.code} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}><span style={{ fontSize: 16, width: 24 }}>{c.flag}</span><span style={{ fontSize: 13, width: 90, flexShrink: 0 }}>{c.name}</span><div style={{ flex: 1 }}><ProgressBar value={c.count} max={4} color={B.accent} /></div><span style={{ fontSize: 13, fontWeight: 700, width: 20, textAlign: "right" }}>{c.count}</span></div>))}</Card>
        <Card><SectionTitle action={<Btn variant="ghost" onClick={()=>setModule("approvals")} size="sm">View All</Btn>}>Pending Approvals</SectionTitle>{PENDING_APPROVALS.slice(0,4).map(a=>(<div key={a.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}><Avatar name={a.employee} size={30} /><div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 13, fontWeight: 700 }}>{a.type}</div><div style={{ fontSize: 11, color: B.textMuted, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{a.employee} — {a.detail}</div></div><StatusBadge status={a.urgency} /></div>))}</Card>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        <Card><SectionTitle>Department Distribution</SectionTitle>{DEPARTMENTS.slice(0,6).map(d=>{const count=EMPLOYEES.filter(e=>e.department===d).length;return(<div key={d} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}><span style={{ fontSize: 13, width: 140, flexShrink: 0 }}>{d}</span><div style={{ flex: 1 }}><ProgressBar value={count} max={6} color={B.blue} /></div><span style={{ fontSize: 13, fontWeight: 700, width: 20, textAlign: "right" }}>{count}</span></div>);})}</Card>
        <Card><SectionTitle>Grant Allocation Overview</SectionTitle>{[{name:"GC - Vitamin A",budget:2400000,spent:1680000,color:B.accent},{name:"BMGF - Food Fortification",budget:1800000,spent:990000,color:B.teal},{name:"USAID - Maternal Nutrition",budget:950000,spent:712000,color:B.blue},{name:"DFID - Adolescent Girls",budget:620000,spent:310000,color:B.purple}].map((g,i)=>(<div key={i} style={{ marginBottom: 12 }}><div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}><span style={{ fontSize: 12, fontWeight: 700 }}>{g.name}</span><span style={{ fontSize: 11, color: B.textMuted }}>{Math.round(g.spent/g.budget*100)}%</span></div><ProgressBar value={g.spent} max={g.budget} color={g.color} /><div style={{ fontSize: 11, color: B.textMuted, marginTop: 2 }}>{fmt(g.spent,"CAD")} / {fmt(g.budget,"CAD")}</div></div>))}</Card>
      </div>
    </div>
  );
};
// â”€â”€â”€ PEOPLE DIRECTORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
        ...
        <Btn variant="secondary" size="sm" onClick={() => setShowUpload(!showUpload)}>ðŸ“¤ Batch Upload</Btn>
      </div>
      {showUpload && (
...
// â”€â”€â”€ BENEFITS PACKAGES BY COUNTRY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const BENEFITS_PACKAGES = {
  CA: { health: "Sun Life Extended Health", dental: "Sun Life Dental", pension: "Group RRSP 5% match", life: "2Ã— salary", disability: "LTD 66.7%", eap: "Homewood Health", extras: ["Paramedical $2,000/yr", "Vision $400/2yr", "Maternity top-up 93% Ã— 17wk"] },
  GB: { health: "Bupa Private Medical", dental: "Denplan Level 3", pension: "Workplace Pension 8% employer", life: "4Ã— salary", disability: "Group Income Protection", eap: "Health Assured", extras: ["Cycle to Work Scheme", "Season Ticket Loan", "Enhanced Parental 26wk full pay"] },
  KE: { health: "AAR Healthcare (Inpatient + Outpatient)", dental: "Included in AAR", pension: "NSSF + Provident Fund 10%", life: "3Ã— salary", disability: "GLA Rider", eap: "LifeWorks Africa", extras: ["Optical KES 20,000/yr", "Maternity Cover", "Last Expense Cover KES 200,000"] },
  NG: { health: "HMO â€” Hygeia / Leadway", dental: "Included in HMO", pension: "Pension Fund Admin (PFA) 18%", life: "Group Life 3Ã— salary", disability: "Included in GLA", eap: "Workplace Options", extras: ["Optical â‚¦50,000/yr", "Maternity Cover", "Housing Allowance 40%"] },
  IN: { health: "Group Mediclaim â‚¹5L family", dental: "Included in Mediclaim", pension: "EPF 12% + Gratuity", life: "EDLI + Group Term 3Ã—", disability: "ESI (if applicable)", eap: "Optum EAP India", extras: ["Top-up â‚¹10L", "Parental Insurance â‚¹3L", "NPS employer 10%"] },
  BD: { health: "Group Health Insurance", dental: "Basic dental included", pension: "Provident Fund 10%", life: "Group Life 2Ã—", disability: "Not statutory", eap: "Internal support", extras: ["Festival Bonus (2Ã—)", "Gratuity after 5yr", "Mobile Allowance"] },
...
// â”€â”€â”€ WORKABLE ATS MOCK DATA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const WORKABLE_REQUISITIONS = [
  { id: "WK-4521", title: "Senior Nutrition Advisor", dept: "Programs", country: "KE", status: "Published", candidates: 34, shortlisted: 8, interviews: 3, daysOpen: 22, hiringMgr: "Sarah Chen", salary: "KES 250,000â€“320,000/mo", url: "https://apply.workable.com/nutrition-intl/j/4521" },
  { id: "WK-4488", title: "Finance Officer â€” Grants", dept: "Finance", country: "NG", status: "Published", candidates: 18, shortlisted: 5, interviews: 2, daysOpen: 35, hiringMgr: "Marcus Johnson", salary: "â‚¦650,000â€“850,000/mo", url: "https://apply.workable.com/nutrition-intl/j/4488" },
  { id: "WK-4502", title: "M&E Specialist", dept: "Research & Evidence", country: "BD", status: "Interview", candidates: 27, shortlisted: 6, interviews: 4, daysOpen: 18, hiringMgr: "Priya Patel", salary: "BDT 95,000â€“120,000/mo", url: "https://apply.workable.com/nutrition-intl/j/4502" },
  { id: "WK-4510", title: "Communications Coordinator", dept: "External Relations", country: "CA", status: "Published", candidates: 42, shortlisted: 10, interviews: 0, daysOpen: 8, hiringMgr: "Oliver Wright", salary: "CAD 65,000â€“78,000/yr", url: "https://apply.workable.com/nutrition-intl/j/4510" },
  { id: "WK-4495", title: "IT Systems Administrator", dept: "IT & Digital", country: "CA", status: "Offer", candidates: 15, shortlisted: 4, interviews: 3, daysOpen: 45, hiringMgr: "Lars MÃ¼ller", salary: "CAD 72,000â€“88,000/yr", url: "https://apply.workable.com/nutrition-intl/j/4495" },
  { id: "WK-4530", title: "Adolescent Nutrition Officer", dept: "Programs", country: "IN", status: "Published", candidates: 21, shortlisted: 3, interviews: 1, daysOpen: 12, hiringMgr: "Fatima Al-Hassan", salary: "â‚¹80,000â€“110,000/mo", url: "https://apply.workable.com/nutrition-intl/j/4530" },
  { id: "WK-4477", title: "Country Director â€” Tanzania", dept: "Executive Office", country: "TZ", status: "Interview", candidates: 12, shortlisted: 4, interviews: 3, daysOpen: 52, hiringMgr: "Ana Silva", salary: "TZS 6,500,000â€“8,000,000/mo", url: "https://apply.workable.com/nutrition-intl/j/4477" },
];

// â”€â”€â”€ EMPLOYEE PROFILE (ENHANCED) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const EmployeeProfile = ({ employee: e, onBack, role }) => {
  ...
  return (
    <div>
      <button onClick={onBack} style={{ background: "none", border: "none", color: B.accent, cursor: "pointer", fontSize: 13, fontWeight: 700, marginBottom: 14, padding: 0, fontFamily: "Arial, sans-serif" }}>â† Back to Directory</button>
      <div style={{ position: "relative", marginBottom: 18 }}>
        <Card style={{ display: "flex", gap: 18, alignItems: "center", flexWrap: "wrap", position: "relative" }}>
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            ...
            <div style={{ fontSize: 13, color: B.textSecondary }}>{e.title} Â· {e.level} Â· {e.department}</div>
            <div style={{ fontSize: 12, color: B.textMuted }}>{e.flag} {country?.entity} Â· {e.email}</div>
          </div>
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
            <Btn variant="primary" onClick={() => setShowLetter(true)}>ðŸ“„ Verification Letter</Btn>
            <Btn variant="secondary" onClick={() => setShowEdit(true)}>âœï¸ Edit</Btn>
            <Btn variant="secondary" onClick={() => setShowActions(!showActions)}>Actions â–¾</Btn>
          </div>
        </Card>
        {/* Actions dropdown â€” positioned outside the Card so it's not clipped */}
        {showActions && (<>
          ...
          <div style={{ position: "absolute", top: "100%", right: 20, marginTop: -6, background: B.white, border: `1px solid ${B.border}`, borderRadius: 10, boxShadow: "0 12px 36px rgba(37,55,70,0.15), 0 4px 12px rgba(37,55,70,0.08)", zIndex: 50, minWidth: 230, overflow: "hidden" }}>
            {[{ label: "ðŸ“‹ View Change History", action: () => setTab("history") },
              { label: "ðŸ’° View Total Rewards", action: () => setTab("totalrewards") },
              { label: "ðŸ”„ Transfer / Reassign", action: () => alert("Transfer workflow initiated for " + e.first + " " + e.last) },
              { label: "ðŸ“Š Performance Review", action: () => alert("Performance review form opened for " + e.first) },
              { label: "ðŸŽ“ Assign Training", action: () => setTab("learning") },
              { label: "â¸ï¸ Place on Leave", action: () => setShowLeaveOfAbsence(true) },
              { label: "ðŸ“¤ Export Profile (PDF)", action: () => alert("Employee profile exported as PDF") },
              ...(role === "hr" || role === "superuser" ? [{ label: "ðŸ”’ Deactivate Employee", action: () => alert("Deactivation requires confirmation â€” this would trigger offboarding workflow"), danger: true }] : []),
            ].map((item, i) => (
      ...
      {/* Edit Employee Modal */}
      <Modal open={showEdit} onClose={() => setShowEdit(false)} title={`Edit Employee â€” ${e.first} ${e.last}`} width={580}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 14 }}>
          ...
          <Btn variant="primary" onClick={() => { alert(`Changes saved for ${e.first} ${e.last}. Effective-dated record created.`); setShowEdit(false); }}>ðŸ’¾ Save Changes</Btn>
        </div>
      </Modal>

      {/* Photo Upload Modal with Centering */}
      <Modal open={showPhotoUpload} onClose={() => { setShowPhotoUpload(false); setPhotoCropMode(false); }} title={`Profile Photo â€” ${e.first} ${e.last}`} width={480}>
        {/* Crop / Center Mode */}
        {photoCropMode && empPhoto ? (
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: "14px 16px", borderRadius: 8, background: B.bgHover, border: `1px solid ${B.border}` }}>
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: B.textMuted, fontFamily: "Arial, sans-serif" }}>â† Horizontal Position â†’</label>
              ...
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: B.textMuted, fontFamily: "Arial, sans-serif" }}>â†‘ Vertical Position â†“</label>
              ...
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: B.textMuted, fontFamily: "Arial, sans-serif" }}>ðŸ” Zoom</label>
              ...
              <div style={{ display: "flex", gap: 6, justifyContent: "center", marginTop: 4 }}>
                <Btn variant="ghost" size="sm" onClick={() => setCropPos({ x: 50, y: 50, scale: 100 })}>â†º Reset to Center</Btn>
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 14 }}>
              ...
              <Btn variant="primary" onClick={() => { setPhotoPos(e.id, { ...cropPos }); setPhotoCropMode(false); setShowPhotoUpload(false); }}>âœ“ Save & Apply</Btn>
            </div>
          </div>
        ) : (
          <div>
            ...
            <div style={{ textAlign: "center", marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 12, color: B.textMuted, marginTop: 8 }}>{empPhoto ? "Current photo" : "No photo uploaded â€” showing initials"}</div>
            </div>
            {/* Drag & drop zone */}
            <div onDragOver={ev => { ev.preventDefault(); setPhotoDragOver(true); }} onDragLeave={() => setPhotoDragOver(false)}
              ...
              <div style={{ fontSize: 12, color: B.textMuted, marginTop: 4 }}>or click to browse â€” JPG, PNG, max 5 MB</div>
            ...
            {empPhoto && (
              <div style={{ display: "flex", gap: 8, justifyContent: "center", marginTop: 14 }}>
                <Btn variant="danger" onClick={() => { setPhoto(e.id, null); }}>ðŸ—‘ Remove</Btn>
                <Btn variant="secondary" onClick={() => { setCropPos(empPhotoPos); setPhotoCropMode(true); }}>âœ‚ Reposition</Btn>
                <Btn variant="secondary" onClick={() => photoInputRef.current?.click()}>ðŸ“· Replace</Btn>
              </div>
            )}
      ...
      <Modal open={showLeaveOfAbsence} onClose={() => setShowLeaveOfAbsence(false)} title={`Place on Leave â€” ${e.first} ${e.last}`} width={640}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px", borderRadius: 8, background: B.bgHover, border: `1px solid ${B.border}`, marginBottom: 16 }}>
          ...
          <div><div style={{ fontSize: 14, fontWeight: 700 }}>{e.first} {e.last}</div><div style={{ fontSize: 12, color: B.textMuted }}>{e.title} Â· {e.department} Â· {e.flag} {e.countryName}</div><div style={{ fontSize: 11, color: B.textMuted }}>Manager: {manager ? `${manager.first} ${manager.last}` : "â€”"} Â· Status: <strong style={{ color: B.success }}>{e.status}</strong></div></div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {loaData.startDate && loaData.endDate && (
            <div style={{ padding: "8px 12px", borderRadius: 6, background: B.accentBg, border: `1px solid ${B.accent}20`, fontSize: 12, color: B.textSecondary }}>
              ...
              {loaData.returnDate && <span> Â· Return: <strong>{fmtDate(loaData.returnDate)}</strong></span>}
            </div>
          )}

          {/* Comments / Reason */}
          <div><label style={{ fontSize: 10, fontWeight: 700, color: B.textMuted, textTransform: "uppercase", letterSpacing: 0.5, display: "block", marginBottom: 4, fontFamily: "Arial, sans-serif" }}>Comments / Reason (Confidential â€” visible to HR only)</label>
          ...
          <div style={{ padding: "12px 14px", borderRadius: 8, background: B.bgHover, border: `1px solid ${B.border}` }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, cursor: "pointer" }}>
                ...
                <span>Notify manager ({manager ? `${manager.first} ${manager.last}` : "â€”"}) of leave placement</span>
              </label>
              <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, cursor: "pointer" }}>
          ...
          <div style={{ padding: "12px 14px", borderRadius: 8, background: `${B.charcoal}06`, border: `1px solid ${B.charcoal}12` }}>
            ...
            <div style={{ fontSize: 11, color: B.textSecondary, lineHeight: 1.7, fontFamily: "monospace" }}>
              ...
              <div><strong>Period:</strong> {loaData.startDate || "â€”"} to {loaData.endDate || "â€”"} ({loaData.startDate && loaData.endDate ? Math.round((new Date(loaData.endDate) - new Date(loaData.startDate)) / 86400000) + " days" : "â€”"})</div>
              <div><strong>Expected Return:</strong> {loaData.returnDate || "â€”"}</div>
              <div><strong>Pay Status:</strong> {loaData.payStatus}</div>
              <div><strong>Return Alert:</strong> {loaData.returnAlert ? `${loaData.returnAlertDays} days before return â†’ Manager + HR` : "Disabled"}</div>
          ...
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", paddingTop: 8, borderTop: `1px solid ${B.border}` }}>
            ...
            <Btn variant="primary" onClick={() => {
              ...
              const msgs = [`âœ… ${e.first} ${e.last} has been placed on ${loaData.type} (${loaData.payStatus}).`, `ðŸ“… Period: ${fmtDate(loaData.startDate)} â€” ${fmtDate(loaData.endDate)}`];
              if (loaData.returnDate) msgs.push(`ðŸ”” Return date: ${fmtDate(loaData.returnDate)}`);
              if (loaData.notifyManager && manager) msgs.push(`ðŸ“§ Manager notification sent to ${manager.first} ${manager.last}`);
              if (loaData.notifyHR) msgs.push(`ðŸ“§ HR notification sent to People & Culture`);
              if (loaData.returnAlert && loaData.returnDate) msgs.push(`â° Return-to-work alert scheduled for ${loaData.returnAlertDays} days before return (${fmtDate(new Date(new Date(loaData.returnDate).getTime() - loaData.returnAlertDays * 86400000).toISOString().split("T")[0])})`);
              if (loaData.backfill) msgs.push(`ðŸ”„ Role flagged for temporary backfill`);
              msgs.push(`\nðŸ“‹ Audit log entry created. Employee status changed to "On Leave".`);
              alert(msgs.join("\n"));
            ...
            }}>â¸ï¸ Confirm Leave Placement</Btn>
          </div>
        </div>
      </Modal>
      ...
      {/* â•â•â• EMPLOYMENT HISTORY (Full Effective-Dated Timeline) â•â•â• */}
      {tab === "history" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {/* Change Timeline */}
                    ...
                    <div style={{ padding: "10px 14px", borderRadius: 6, background: B.bgHover, border: `1px solid ${B.borderLight}` }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12 }}>
                        {h.oldValue !== "â€”" && (
                          ...
                          <span style={{ color: B.textMuted }}>â†’</span></>
                        )}
              ...
              {e.perfHistory.map((p, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 11, color: B.textMuted }}>Reviewer: {p.reviewer} Â· {p.rating >= 4.5 ? "Exceptional" : p.rating >= 4 ? "Exceeds Expectations" : p.rating >= 3.5 ? "Meets Expectations" : "Developing"}</div>
                  </div>
      ...
      {/* â•â•â• MY LEARNING (LMS Integration) â•â•â• */}
      {tab === "learning" && (() => {
        const myCourses = [
            ...
            <Card style={{ marginBottom: 14 }}>
              ...
              {myCourses.map((c, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 12px", borderRadius: 6, background: c.status === "Completed" ? B.successBg : c.status === "In Progress" ? B.warningBg : B.bgHover, marginBottom: 4, border: `1px solid ${c.status === "Completed" ? `${B.success}15` : c.status === "In Progress" ? `${B.warning}15` : B.borderLight}` }}>
                  <div style={{ width: 22, height: 22, borderRadius: 11, background: c.status === "Completed" ? B.success : c.status === "In Progress" ? B.warning : B.bgCard, border: `2px solid ${c.status === "Completed" ? B.success : c.status === "In Progress" ? B.warning : B.border}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#fff", flexShrink: 0 }}>{c.status === "Completed" ? "âœ“" : c.status === "In Progress" ? "â—" : ""}</div>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 11, color: B.textMuted }}>Path: {c.path}{c.date ? ` Â· Completed ${fmtDate(c.date)}` : ""}{c.score ? ` Â· Score: ${c.score}%` : ""}</div>
                  </div>
            ...
            <Card>
              ...
              {[{ title: "Advanced Data Analysis for Program Impact", reason: "Aligns with your M&E skills", hours: "4 hrs" },
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 6, background: B.bgHover, marginBottom: 4 }}>
                  ...
                  <div style={{ flex: 1 }}><div style={{ fontSize: 12, fontWeight: 700 }}>{r.title}</div><div style={{ fontSize: 10, color: B.textMuted }}>{r.reason} Â· {r.hours}</div></div>
                  <Btn variant="ghost" size="sm" style={{ color: B.accent }} onClick={() => alert(`Enrolled in: ${r.title}`)}>Enroll â†’</Btn>
                </div>
              ))}
            </Card>
          </div>
      ...
      {tab === "benefits" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.teal}` }}>
            <SectionTitle>Core Benefits â€” {e.flag} {e.countryName}</SectionTitle>
            {[
              { label: "Health Insurance", value: benefits.health, icon: "ðŸ¥" },
              { label: "Dental", value: benefits.dental, icon: "ðŸ¦·" },
              { label: "Pension / Retirement", value: benefits.pension, icon: "ðŸ¦" },
              { label: "Life Insurance", value: benefits.life, icon: "ðŸ›¡ï¸" },
              { label: "Disability", value: benefits.disability, icon: "â™¿" },
              { label: "Employee Assistance (EAP)", value: benefits.eap, icon: "ðŸ’¬" },
            ].map((b, i) => (
      ...
      {tab === "compensation" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          ...
          <Card><SectionTitle>Compensation History</SectionTitle>{[...e.compHistory].reverse().map((h, i) => (<div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${B.borderLight}` }}><div><div style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>{fmt(h.salary, e.currency, e.locale)}</div><div style={{ fontSize: 11, color: B.textMuted }}>{h.reason} Â· Approved by {h.approvedBy}</div></div><span style={{ fontSize: 12, color: B.textMuted }}>{fmtDate(h.effectiveDate)}</span></div>))}</Card>
        </div>
      )}
      ...
      {tab === "totalrewards" && (() => {
        ...
        const sections = [
          { title: "Direct Compensation", subtitle: "Your cash earnings for the statement period", icon: "ðŸ’°", color: B.accent, total: directComp, items: [
          ...
          { title: "Employer-Paid Benefits", subtitle: "NI pays these premiums on your behalf â€” you don't see them on your payslip, but they protect you and your family", icon: "ðŸ›¡ï¸", color: B.teal, total: benefitsTotal, items: [
            ...
            { label: "Life Insurance", value: lifePremium, explain: `Group life coverage at ${e.country === "KE" ? "3" : "2"}Ã— your annual salary` },
            ...
            { label: "Pension / Retirement Contribution", value: pensionContrib, explain: `NI contributes this to your retirement plan â€” this is in addition to any employee contributions you make` },
          ]},
          { title: "Time-Based Rewards", subtitle: "The value of your paid time away from work â€” these days are yours to use for rest, health, and personal needs", icon: "ðŸ“…", color: B.blue, total: timeBasedTotal, items: [
            ...
            { label: `Sick Leave (${e.leaveBalance.sick} days)`, value: sickLeaveValue, explain: "Paid sick days â€” use without worry when you need them" },
          ...
          { title: "Perks, Growth & Wellbeing", subtitle: "Investments in your development, health, and quality of life", icon: "ðŸŒ±", color: B.purple, total: perksTotal, items: [
        ...
        return (
          <div>
            ...
            <Card style={{ marginBottom: 14, background: `linear-gradient(135deg, ${B.charcoal}, ${B.grey})`, color: "#fff", border: "none", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, opacity: 0.8, marginTop: 4 }}>Statement Period: January 1 â€“ December 31, 2026 Â· {e.flag} {e.entity} Â· {e.title}</div>
                </div>
              </div>
              <div style={{ marginTop: 14, padding: "12px 16px", borderRadius: 8, background: "rgba(255,255,255,0.1)", backdropFilter: "blur(4px)" }}>
                <div style={{ fontSize: 12, opacity: 0.9, lineHeight: 1.7 }}>
                  Your total rewards reflect NI's commitment to competitive pay, meaningful benefits, and investment in your growth. This statement shows everything NI provides â€” well beyond your payslip â€” so you can see the full value of being part of our mission to nourish life.
                </div>
              </div>
            </Card>
            ...
            <Card style={{ marginBottom: 14, borderTop: `4px solid ${B.accent}`, textAlign: "center", padding: 24 }}>
              ...
              <div style={{ fontSize: 13, color: B.textSecondary, marginTop: 4 }}>This is the total investment NI makes in you each year â€” {Math.round(grandTotal / e.salary * 100 - 100)}% more than your base salary alone</div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 10, padding: "6px 14px", borderRadius: 20, background: B.successBg, border: `1px solid ${B.success}20` }}>
                <span style={{ color: B.success, fontWeight: 700, fontSize: 13 }}>â†‘ {yoyGrowth}% year-over-year growth</span>
            ...
            <Card style={{ borderTop: `4px solid ${B.teal}` }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 14 }}>
                {[{ icon: "ðŸ”’", title: "Security", desc: "Health, life, and disability coverage protect you and your family. Your pension builds long-term financial stability." },
                  { icon: "ðŸ“ˆ", title: "Growth", desc: `Your L&D allowance of ${fmt(ldAllow, e.currency, e.locale)} and our career development programs support your professional journey.` },
                  { icon: "âš–ï¸", title: "Balance", desc: `${e.leaveBalance.annual + e.leaveBalance.sick + e.leaveBalance.personal} days of paid leave plus flexible work arrangements help you manage work and life.` },
                ].map((m, i) => (
              ...
              <div style={{ padding: 14, borderRadius: 8, background: B.accentBg, border: `1px solid ${B.accent}20`, fontSize: 12, color: B.textSecondary, lineHeight: 1.7 }}>
                <strong style={{ color: B.accent }}>Our Total Rewards Philosophy:</strong> Nutrition International is committed to market-competitive compensation, strong retirement and health benefits, meaningful development opportunities, and flexible work â€” because investing in you enables our mission to nourish life around the world. If you have questions about any part of your rewards, please contact People & Culture at hr@nutritionintl.org.
              </div>
            </Card>

            {/* Actions */}
            <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
              <Btn variant="primary" onClick={() => alert("Total Rewards Statement downloaded as PDF")}>â¬‡ Download PDF Statement</Btn>
              <Btn variant="secondary" onClick={() => alert(`Statement emailed to ${e.email}`)}>âœ‰ Email My Statement</Btn>
      ...
      {/* â•â•â• RECRUITING / WORKABLE (Manager Only) â•â•â• */}
        ...
        <div>
          <div style={{ padding: "10px 14px", borderRadius: 6, background: `${B.blue}08`, border: `1px solid ${B.blue}20`, marginBottom: 14, display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, fontSize: 12, color: B.textSecondary }}>
              <strong>Workable ATS Integration</strong> â€” Connected via Open API. Data syncs every 15 minutes. <a href="https://nutrition-intl.workable.com" target="_blank" rel="noopener noreferrer" style={{ color: B.blue, fontWeight: 700 }}>Open Workable Dashboard â†’</a>
            </div>
            ...
            <Card key={req.id} style={{ marginBottom: 10, borderLeft: `4px solid ${req.status === "Offer" ? B.success : req.status === "Interview" ? B.purple : B.blue}` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: B.textMuted, marginTop: 2 }}>{req.dept} Â· {COUNTRIES.find(c => c.code === req.country)?.flag} {COUNTRIES.find(c => c.code === req.country)?.name} Â· {req.salary}</div>
                </div>
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                <Btn variant="secondary" size="sm" onClick={() => window.open(req.url, "_blank")}>ðŸ“‹ View Candidates</Btn>
                <Btn variant="secondary" size="sm" onClick={() => window.open(req.url + "/description", "_blank")}>ðŸ“„ Job Description</Btn>
                <Btn variant="ghost" size="sm" style={{ color: B.blue }}onClick={() => alert('Opening requisition in Workable ATS...')}>â†— Open in Workable</Btn>
              </div>
            </Card>
          ))}
        </div>
      ...
      {/* â•â•â• DOCUMENTS (with Verification Letter) â•â•â• */}
      {tab === "documents" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.accent}` }}>
            ...
            <Btn variant="primary" style={{ width: "100%" }} onClick={() => { setShowLetter(true); setLetterGenerated(true); }}>ðŸ“„ Generate & Preview Letter</Btn>
          </Card>
          <Card>
            <SectionTitle>Employee Documents on File</SectionTitle>
            <Table columns={[
              { label: "Document", render: r => <div style={{ display: "flex", alignItems: "center", gap: 6 }}><span style={{ fontSize: 14 }}>ðŸ“„</span><span style={{ fontWeight: 600 }}>{r.name}</span></div> },
              { label: "Date", render: r => fmtDate(r.date) },
              { label: "Status", render: r => <StatusBadge status={r.status} /> },
            ]} data={[
      ...
      {/* â•â•â• VERIFICATION LETTER MODAL â•â•â• */}
      <Modal open={showLetter} onClose={() => setShowLetter(false)} title="Employment Verification Letter â€” Preview" width={680}>
        <div style={{ background: B.white, border: `1px solid ${B.border}`, borderRadius: 8, padding: 32, fontFamily: "Georgia, serif", fontSize: 13, lineHeight: 1.8, color: B.textPrimary }}>
          ...
          <div style={{ marginTop: 20, padding: "8px 12px", borderRadius: 4, background: B.bgHover, fontSize: 10, color: B.textMuted, fontFamily: "Arial, sans-serif" }}>
            Document ID: EVL-{e.id}-{new Date().getTime().toString(36).toUpperCase()} Â· Generated: {todayStr} Â· This letter is electronically signed and is valid without a physical signature.
          </div>
        </div>
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 16 }}>
          <Btn variant="secondary" onClick={() => setShowLetter(false)}>Close</Btn>
          <Btn variant="primary" onClick={() => { alert("Letter downloaded as PDF"); setShowLetter(false); }}>â¬‡ Download PDF</Btn>
          <Btn variant="primary" style={{ background: B.teal }} onClick={() => { alert(`Letter emailed to ${e.email}`); setShowLetter(false); }}>âœ‰ Email to Employee</Btn>
        </div>
      </Modal>
    </div>
  );
...
// â”€â”€â”€ LABOR LAW COMPLIANCE DATA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const LABOR_LAWS = {
  CA: { maxDaily: 8, maxWeekly: 44, otMultiplier: 1.5, restBreak: "30 min after 5h", minRest: "8h between shifts", notes: "Overtime after 44h/week at 1.5Ã—. Ontario ESA governs. Statutory holidays paid at premium.", currency: "CAD", otRate: 37.50 },
  GB: { maxDaily: 8, maxWeekly: 48, otMultiplier: 1.0, restBreak: "20 min after 6h", minRest: "11h between shifts", notes: "Working Time Regulations 1998. Opt-out available for 48h cap. No statutory OT premium â€” contractual.", currency: "GBP", otRate: 22.00 },
  ...
  MW: { maxDaily: 8, maxWeekly: 48, otMultiplier: 1.5, restBreak: "1h after 5h", minRest: "Consecutive 24h/week", notes: "Employment Act 2000. OT at 1.5Ã— weekday, 2Ã— Sunday/holiday. Max 12h OT/week.", currency: "MWK", otRate: 2500 },
  KE: { maxDaily: 8, maxWeekly: 52, otMultiplier: 1.5, restBreak: "1h after 6h continuous", minRest: "24 consecutive hours/week", notes: "Employment Act 2007. OT at 1.5Ã— normal, 2Ã— on rest days. Night workers limited to 8h.", currency: "KES", otRate: 750 },
  NG: { maxDaily: 8, maxWeekly: 40, otMultiplier: 1.5, restBreak: "1h after 6h", minRest: "24 consecutive hours/week", notes: "Labour Act Cap L1 LFN 2004. OT not mandatory but must be at 1.5Ã— minimum. 12 days paid leave/year.", currency: "NGN", otRate: 3200 },
  SN: { maxDaily: 8, maxWeekly: 40, otMultiplier: 1.15, restBreak: "1h after 4h", minRest: "24 consecutive hours/week", notes: "Code du Travail. First 8 OT hrs at 15%, next at 40%, night/holiday at 60â€“100%. 24 working days leave.", currency: "XOF", otRate: 4500 },
  TZ: { maxDaily: 9, maxWeekly: 45, otMultiplier: 1.5, restBreak: "1h daily", minRest: "24 consecutive hours/week", notes: "Employment and Labour Relations Act 2004. OT at 1.5Ã— weekday, 2Ã— rest days. Max 50h OT/4-week cycle.", currency: "TZS", otRate: 15000 },
  BD: { maxDaily: 8, maxWeekly: 48, otMultiplier: 2.0, restBreak: "1h after 6h", minRest: "1 day/week", notes: "Bangladesh Labour Act 2006. OT at 2Ã— basic wage. Max 10h/day including OT. Festival leave 11 days.", currency: "BDT", otRate: 800 },
  IN: { maxDaily: 9, maxWeekly: 48, otMultiplier: 2.0, restBreak: "30 min after 5h", minRest: "24 consecutive hours/week", notes: "Factories Act / Code on Wages 2019. OT at 2Ã— ordinary rate. State-specific rules may apply. PF/ESI applicable.", currency: "INR", otRate: 600 },
  PK: { maxDaily: 9, maxWeekly: 48, otMultiplier: 2.0, restBreak: "1h after 5h", minRest: "1 day/week", notes: "Factories Act 1934 / provincial laws. OT at 2Ã— ordinary rate. Max 56h/week including OT.", currency: "PKR", otRate: 1200 },
  ID: { maxDaily: 7, maxWeekly: 40, otMultiplier: 1.5, restBreak: "30 min after 4h", minRest: "1 day/week (or 2 for 5-day)", notes: "Manpower Law No. 13/2003 (Cipta Kerja amendments). First OT hour at 1.5Ã—, subsequent at 2Ã—. Max 4h OT/day, 18h/week.", currency: "IDR", otRate: 85000 },
...
const GRANTS_PROJECTS = [
  { id: "GA-2024-001", name: "GC â€“ Vitamin A Supplementation", donor: "Global Affairs Canada", budget: 2400000, currency: "CAD", color: B.accent },
  { id: "GA-2024-015", name: "BMGF â€“ Food Fortification", donor: "Bill & Melinda Gates Foundation", budget: 1800000, currency: "USD", color: B.teal },
  { id: "GA-2024-032", name: "USAID â€“ Maternal Nutrition", donor: "USAID", budget: 950000, currency: "USD", color: B.blue },
  { id: "GA-2024-044", name: "FCDO â€“ Adolescent Girls", donor: "UK FCDO", budget: 620000, currency: "GBP", color: B.purple },
  { id: "GA-2024-055", name: "EU â€“ Rice Fortification Bangladesh", donor: "European Commission", budget: 480000, currency: "EUR", color: B.orange },
  { id: "GA-2024-061", name: "CIDA â€“ Zinc Supplementation", donor: "Govt of Canada", budget: 350000, currency: "CAD", color: B.yellow },
];
...
const TimeModule = ({ employee: empProp } = {}) => {
  ...
  // â”€â”€â”€ Sub-component: Inline field label â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• CLOCK IN/OUT (Mobile-First, GPS, Offline) â•â•â•â•â•â•â• */}
      {tab === "clock" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          {/* Clock Card */}
          <Card style={{ position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 700, color: isOnline ? B.success : B.textMuted }}>{isOnline ? "ðŸŸ¢ ONLINE" : "ðŸ”´ OFFLINE MODE"}</span>
            </div>
            {!isOnline && (
            ...
            {gpsLocation && clockedIn && (
              <div style={{ padding: "8px 12px", borderRadius: 6, background: B.successBg, border: `1px solid ${B.success}20`, marginBottom: 12, fontSize: 11, color: B.textSecondary, display: "flex", alignItems: "center", gap: 6 }}>
                ...
                GPS Verified: {gpsLocation.lat}, {gpsLocation.lng} â€” Nairobi, Kenya
              </div>
            )}
            ...
            {!isOnline && offlineQueue.length > 0 && (
              <Btn variant="secondary" style={{ width: "100%", marginTop: 10 }} onClick={handleSync}>
                â†» Sync {offlineQueue.length} Queued Event{offlineQueue.length > 1 ? "s" : ""}
              </Btn>
            )}
          </Card>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <Card>
              ...
              {[
                { time: "08:02 AM", action: "Clock In", grant: "GC â€“ Vitamin A", gps: "Nairobi, KE", mode: "Online", icon: "ðŸŸ¢" },
                { time: "12:05 PM", action: "Clock Out (Lunch)", grant: "â€”", gps: "Nairobi, KE", mode: "Online", icon: "ðŸŸ¡" },
                { time: "12:58 PM", action: "Clock In", grant: "BMGF â€“ Fortification", gps: "Field Site, Kiambu", mode: "Offline", icon: "ðŸ”´" },
                { time: "03:30 PM", action: "Grant Switch", grant: "USAID â€“ Maternal", gps: "Kiambu", mode: "Offline", icon: "ðŸ”µ" },
              ].map((log, i) => (
            ...
            <Card>
              ...
              {offlineQueue.length === 0 ? (
                <div style={{ textAlign: "center", padding: 16, color: B.textMuted, fontSize: 13 }}>
                  {isOnline ? "âœ“ All events synced â€” no items in queue" : "No queued events yet. Clock in/out while offline to queue events."}
                </div>
              ) : (
                offlineQueue.map((item, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 6, background: item.synced ? B.successBg : B.warningBg, border: `1px solid ${item.synced ? B.success : B.warning}20`, marginBottom: 4 }}>
                    <span style={{ fontSize: 14 }}>{item.synced ? "âœ…" : "â³"}</span>
                    <div style={{ flex: 1, fontSize: 12 }}>
                      <span style={{ fontWeight: 700 }}>{item.action.replace("_", " ").toUpperCase()}</span>
                      <span style={{ color: B.textMuted }}> Â· {new Date(item.time).toLocaleTimeString()}</span>
                      {item.gps && <span style={{ color: B.textMuted }}> Â· GPS: {item.gps.lat}, {item.gps.lng}</span>}
                    </div>
            ...
            <Card>
              ...
              <div style={{ fontSize: 11, color: B.textMuted, marginTop: 6 }}>4 field staff clocked in across 3 sites Â· Last updated 2 min ago</div>
            </Card>
          </div>
        </div>
      )}

      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• WEEKLY TIMESHEET â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "attendance" && (
        <div>
          <div style={{ display: "flex", gap: 10, marginBottom: 14, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <Select value={countryFilter} onChange={setCountryFilter} options={[{ value: "ALL", label: "All Countries" }, ...COUNTRIES.map(c => ({ value: c.code, label: `${c.flag} ${c.name}` }))]} />
            <Btn variant="secondary" size="sm" style={{ marginLeft: "auto" }} onClick={() => alert("Batch upload: drag Excel with Employee ID, Week, Mon-Fri hours, Grant Code columns")}>ðŸ“¤ Batch Upload Timesheets</Btn>
          </div>
                ...
                {timesheetData.filter(r => countryFilter === "ALL" || r.country === countryFilter).map((r, ri) => {
                  ...
                  return (
                    <tr key={ri} style={{ borderBottom: `1px solid ${B.borderLight}` }}
                      ...
                      <td style={{ padding: "8px 6px", textAlign: "center" }}>
                        {r.ot > 0 ? <Badge color={B.orange} bg={B.warningBg}>{r.ot}h @ {r.lawData.otMultiplier}Ã—</Badge> : <span style={{ color: B.textMuted }}>â€”</span>}
                      </td>
                      <td style={{ padding: "8px 6px", fontSize: 10 }}>
                        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                            <div style={{ width: 6, height: 6, borderRadius: 3, background: B.accent }} />
                            <span>{(r.g1Pct * 100).toFixed(0)}% {r.g1Name?.split(" â€“ ")[0]}</span>
                          </div>
                          {r.g2Name && <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                            <div style={{ width: 6, height: 6, borderRadius: 3, background: B.teal }} />
                            <span>{(r.g2Pct * 100).toFixed(0)}% {r.g2Name?.split(" â€“ ")[0]}</span>
                          </div>}
                        </div>
                      </td>
                      <td style={{ padding: "8px 6px" }}>
                        {overMax ? (
                          <Badge color={B.danger} bg={B.dangerBg}>âš  Exceeds {r.lawData.maxWeekly}h</Badge>
                        ) : (
                          <Badge color={B.success} bg={B.successBg}>âœ“ Compliant</Badge>
                        )}
                      </td>
                      <td style={{ padding: "8px 6px" }}>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• GRANT / PROJECT TRACKING â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "grants" && (
        <div>
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 10 }}>
            <Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag Excel with Employee ID, Grant Code, Allocation %, Period, Hours columns")}>ðŸ“¤ Batch Upload Allocations</Btn>
          </div>
                ...
                <Card key={g.id} onClick={() => setShowGrantDetail(g)} style={{ borderLeft: `4px solid ${g.color}`, cursor: "pointer" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: B.textMuted }}>{g.donor} Â· {g.currency}</div>
                    </div>
                  ...
                  <div style={{ marginTop: 8 }}>
                    ...
                    <div style={{ fontSize: 10, color: B.textMuted, marginTop: 3 }}>Budget: {fmt(g.budget, g.currency)} Â· {Math.round(hoursLogged / 3000 * 100)}% hours used</div>
                  </div>
                </Card>
              );
            })}
          ...
          <Card>
            <SectionTitle>Staff Allocation by Grant â€” Current Period</SectionTitle>
            <Table columns={[
              { label: "Employee", render: r => <div style={{ display: "flex", alignItems: "center", gap: 6 }}><Avatar name={`${r.first} ${r.last}`} size={24} /><div><span style={{ fontWeight: 600, fontSize: 12 }}>{r.first} {r.last}</span><div style={{ fontSize: 10, color: B.textMuted }}>{r.flag} {r.countryName} Â· {r.currency}</div></div></div> },
              { label: "Grant 1 (%)", render: r => (<div style={{ display: "flex", alignItems: "center", gap: 6 }}><div style={{ width: 8, height: 8, borderRadius: 4, background: B.accent }} /><span>{(r.grants[0]?.allocation * 100).toFixed(0)}% â€” {r.grants[0]?.name?.split(" â€“ ")[0]}</span></div>) },
              { label: "Grant 2 (%)", render: r => r.grants[1] ? (<div style={{ display: "flex", alignItems: "center", gap: 6 }}><div style={{ width: 8, height: 8, borderRadius: 4, background: B.teal }} /><span>{(r.grants[1]?.allocation * 100).toFixed(0)}% â€” {r.grants[1]?.name?.split(" â€“ ")[0]}</span></div>) : <span style={{ color: B.textMuted }}>â€”</span> },
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• LABOR COMPLIANCE â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "compliance" && (
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card style={{ borderTop: `4px solid ${B.accent}` }}>
              <SectionTitle>{compCountry?.flag} Labor Law Summary â€” {compCountry?.name}</SectionTitle>
              {[
                { label: "Max Daily Hours", value: `${law.maxDaily}h`, icon: "â±" },
                { label: "Max Weekly Hours", value: `${law.maxWeekly}h`, icon: "ðŸ“…" },
                { label: "Overtime Multiplier", value: `${law.otMultiplier}Ã— base rate`, icon: "ðŸ’°" },
                { label: "Mandatory Rest Break", value: law.restBreak, icon: "â˜•" },
                { label: "Minimum Rest Between Shifts", value: law.minRest, icon: "ðŸŒ™" },
                { label: "OT Hourly Rate", value: fmt(law.otRate, law.currency), icon: "ðŸ’µ" },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
            ...
            <Card>
              ...
              {[
                ...
                { name: "Grace Okafor", issue: "5 consecutive work days â€” rest day required", severity: "warning" },
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 6, background: alert.severity === "danger" ? B.dangerBg : B.warningBg, border: `1px solid ${alert.severity === "danger" ? B.danger : B.warning}20`, marginBottom: 6 }}>
                  <span style={{ fontSize: 14 }}>{alert.severity === "danger" ? "ðŸš¨" : "âš ï¸"}</span>
                  <div style={{ flex: 1 }}>
          ...
          <Card style={{ marginTop: 14 }}>
            <SectionTitle>Labor Law Comparison â€” All Entities</SectionTitle>
                  ...
                  {COUNTRIES.map(c => {
                    ...
                    return l ? (
                      <tr key={c.code} style={{ borderBottom: `1px solid ${B.borderLight}` }}
                        ...
                        <td style={{ padding: "8px 10px" }}>{l.otMultiplier}Ã—</td>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• LEAVE REQUESTS (Enhanced) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "requests" && (
        <div>
          <div style={{ display: "flex", gap: 10, marginBottom: 14, justifyContent: "space-between", flexWrap: "wrap" }}>
            <Select value={countryFilter} onChange={setCountryFilter} options={[{ value: "ALL", label: "All Countries" }, ...COUNTRIES.map(c => ({ value: c.code, label: `${c.flag} ${c.name}` }))]} />
            <div style={{ display: "flex", gap: 6 }}>
              <Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag Excel with Employee ID, Leave Type, Start Date, End Date, Days columns")}>ðŸ“¤ Batch Upload</Btn>
            ...
            {filteredRequests.map(r => (
              <Card key={r.id} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13, color: B.textSecondary }}>{r.type} Â· {fmtDate(r.from)} â€“ {fmtDate(r.to)} ({r.days} days)</div>
                  <div style={{ fontSize: 12, color: B.textMuted }}>{r.reason} Â· Submitted {fmtDate(r.submitted)}</div>
                ...
                {r.status === "Pending" && (
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    <Btn variant="success" size="sm" onClick={() => handleApprove(r.id)}>âœ“ Approve</Btn>
                    <Btn variant="danger" size="sm" onClick={() => handleReject(r.id)}>âœ• Reject</Btn>
                  </div>
                )}
              </Card>
            ))}
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• HOLIDAY CALENDARS (Editable) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "calendars" && (
        <div>
          {/* Dec 1 Alert Banner */}
          {showDecAlert && (
            <div style={{ padding: "12px 16px", borderRadius: 8, background: B.dangerBg, border: `1px solid ${B.danger}25`, marginBottom: 14, display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: B.textSecondary }}>It's December â€” please review and update public holiday dates for all countries for the 2027 calendar year. Ensure holidays are confirmed with local offices before year-end payroll processing.</div>
              </div>
              <Btn variant="danger" size="sm" onClick={() => { setCalendarYear("2027"); alert("Switched to 2027 calendar. Add holidays for each country."); }}>Set Up 2027 â†’</Btn>
            </div>
          )}
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 14, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <Btn variant="secondary" size="sm" style={{ marginLeft: "auto" }} onClick={() => alert("Batch upload: drag Excel with Country Code, Holiday Name, Date columns")}>ðŸ“¤ Batch Upload</Btn>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            {Object.keys(holidays).filter(code => holidayCountryFilter === "ALL" || code === holidayCountryFilter).map(code => {
              ...
              return (
                <Card key={code}>
                  <SectionTitle action={<Btn variant="primary" size="sm" onClick={() => { setHolidayForm({ name: "", date: "" }); setShowHolidayEdit({ country: code, idx: "new" }); }}>+ Add Holiday</Btn>}>{c?.flag} {c?.name} â€” {calendarYear} ({countryHolidays.length})</SectionTitle>
                  {countryHolidays.map((h, i) => {
                    ...
                    return (
                      <div key={h.id || i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 10px", borderRadius: 6, background: isUpcoming ? B.warningBg : B.bgHover, marginBottom: 4, opacity: isPast ? 0.55 : 1, border: `1px solid ${isUpcoming ? `${B.warning}20` : "transparent"}` }}>
                        ...
                        <Btn variant="ghost" size="sm" onClick={() => { setHolidayForm({ name: h.name, date: h.date }); setShowHolidayEdit({ country: code, idx: i }); }}>âœï¸</Btn>
                        <button onClick={() => { setHolidays(prev => ({ ...prev, [code]: prev[code].filter((_, idx) => idx !== i) })); }} style={{ background: "none", border: "none", color: B.danger, cursor: "pointer", fontSize: 14, padding: "0 4px" }}>âœ•</button>
                      </div>
                    );
                  })}
          ...
          <Modal open={!!showHolidayEdit} onClose={() => setShowHolidayEdit(null)} title={showHolidayEdit?.idx === "new" ? `Add Holiday â€” ${COUNTRIES.find(c => c.code === showHolidayEdit?.country)?.name || ""}` : `Edit Holiday â€” ${COUNTRIES.find(c => c.code === showHolidayEdit?.country)?.name || ""}`} width={450}>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ padding: 10, borderRadius: 6, background: `${B.charcoal}06`, border: `1px solid ${B.charcoal}12`, fontSize: 11, color: B.textMuted, fontFamily: "monospace" }}>
                ...
                <div><strong>Holiday:</strong> {holidayForm.name || "â€”"} on {holidayForm.date || "â€”"}</div>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                ...
                }}>ðŸ’¾ {showHolidayEdit?.idx === "new" ? "Add Holiday" : "Save Changes"}</Btn>
              </div>
            </div>
          </Modal>
        </div>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• MULTI-CURRENCY PAYROLL â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {tab === "multicurrency" && (
        <div>
          <Card style={{ marginBottom: 14 }}>
            <SectionTitle>Multi-Currency Payroll Summary â€” Current Period</SectionTitle>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, fontFamily: "Arial, sans-serif" }}>
                <thead><tr style={{ background: B.bgHover }}>
                  ...
                  {COUNTRIES.map(c => {
                    ...
                    return (
                      <tr key={c.code} style={{ borderBottom: `1px solid ${B.borderLight}` }}
                        ...
                        <td style={{ padding: "8px 10px" }}>{otPay > 0 ? fmt(otPay, c.currency, c.locale) : "â€”"}</td>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card>
              ...
              <div style={{ fontSize: 10, color: B.textMuted, marginTop: 8 }}>Rates updated: Apr 23, 2026 Â· Source: Treasury rate feed</div>
            </Card>
            <Card>
              <SectionTitle>Payroll by Currency â€” Consolidated (USD)</SectionTitle>
              {[{ curr: "CAD ðŸ‡¨ðŸ‡¦", usd: 42300, pct: 28 }, { curr: "KES ðŸ‡°ðŸ‡ª", usd: 18900, pct: 12 }, { curr: "GBP ðŸ‡¬ðŸ‡§", usd: 31200, pct: 20 }, { curr: "INR ðŸ‡®ðŸ‡³", usd: 12400, pct: 8 }, { curr: "NGN ðŸ‡³ðŸ‡¬", usd: 8700, pct: 6 }, { curr: "Others", usd: 39500, pct: 26 }].map((item, i) => (
...
// â”€â”€â”€ WORKFLOW BUILDER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }}>
              {wf.steps.map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  {i < wf.steps.length - 1 && <span style={{ color: B.textMuted, fontSize: 10 }}>â†’</span>}
                </div>
              ))}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ fontSize: 11, color: B.textMuted }}>SLA: {wf.sla} Â· Countries: {wf.countries}</div>
              <div style={{ display: "flex", gap: 4 }}>
                <Btn variant="secondary" size="sm" onClick={() => openEdit(wf)}>âœï¸ Edit</Btn>
                <Btn variant="ghost" size="sm" onClick={() => setSelectedWF(wf)}>ðŸ‘ View</Btn>
                <Btn variant="ghost" size="sm" style={{ color: wf.status === "Active" ? B.warning : B.success }} onClick={() => setWorkflows(prev => prev.map(w => w.id === wf.id ? { ...w, status: w.status === "Active" ? "Inactive" : "Active" } : w))}>{wf.status === "Active" ? "â¸" : "â–¶"}</Btn>
              </div>
            </div>
          </Card>
        ))}
        ...
        {selectedWF && (
          <div>
              ...
              {selectedWF.steps.map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div style={{ flex: 1, padding: "10px 14px", borderRadius: 6, background: B.bgHover, border: `1px solid ${B.border}` }}>
                    ...
                    <span style={{ color: B.textMuted }}> â€” {s.action}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16, justifyContent: "flex-end" }}>
              <Btn variant="secondary" onClick={() => { setSelectedWF(null); openEdit(selectedWF); }}>âœï¸ Edit This Workflow</Btn>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {editForm.steps.map((s, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", borderRadius: 8, border: `1px solid ${B.border}`, marginBottom: 6, background: B.bgHover }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 0, flexShrink: 0 }}>
                  <button onClick={() => moveStep(i, -1)} disabled={i === 0} style={{ background: "none", border: "none", cursor: i === 0 ? "default" : "pointer", fontSize: 10, color: i === 0 ? B.borderLight : B.textMuted, padding: "0 2px", lineHeight: 1 }}>â–²</button>
                  <button onClick={() => moveStep(i, 1)} disabled={i === editForm.steps.length - 1} style={{ background: "none", border: "none", cursor: i === editForm.steps.length - 1 ? "default" : "pointer", fontSize: 10, color: i === editForm.steps.length - 1 ? B.borderLight : B.textMuted, padding: "0 2px", lineHeight: 1 }}>â–¼</button>
                </div>
                {/* Role */}
                ...
                <span style={{ color: B.textMuted, fontSize: 12 }}>â†’</span>
                {/* Action */}
                ...
                {/* Delete */}
                <button onClick={() => removeStep(i)} disabled={editForm.steps.length <= 1} style={{ background: "none", border: "none", color: editForm.steps.length <= 1 ? B.borderLight : B.danger, cursor: editForm.steps.length <= 1 ? "default" : "pointer", fontSize: 16, padding: "0 4px" }}>âœ•</button>
              </div>
            ))}
          </div>
          ...
          <div style={{ padding: 10, borderRadius: 6, background: `${B.charcoal}06`, border: `1px solid ${B.charcoal}12`, fontSize: 11, color: B.textMuted }}>
            {editingWF === "new"
              ...
              : `Editing workflow "${editForm.name}" â€” changes take effect immediately for all future triggers. In-flight instances continue under the previous configuration. This change will be recorded in the audit trail.`}
          </div>
          ...
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", paddingTop: 10, borderTop: `1px solid ${B.border}` }}>
            {editingWF !== "new" && (
              ...
              }}>ðŸ—‘ Delete Workflow</Btn>
            )}
            <Btn variant="secondary" onClick={() => setEditingWF(null)}>Cancel</Btn>
            <Btn variant="primary" onClick={saveWorkflow}>ðŸ’¾ {editingWF === "new" ? "Create Workflow" : "Save Changes"}</Btn>
          </div>
        </div>
      </Modal>
    </div>
    ...
    <div>
      ...
      <Card style={{ marginBottom: 16 }}>
        ...
        <div onDragOver={e => { e.preventDefault(); setDragOver(true); }} onDragLeave={() => setDragOver(false)} onDrop={handleDrop}
          ...
          <div style={{ fontSize: 12, color: B.textMuted }}>PDF, JPG, PNG â€” receipts will be automatically parsed via OCR</div>
        </div>
        {uploads.length > 0 && (
          <div style={{ marginTop: 14 }}>
            ...
            {uploads.map((u, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", borderRadius: 6, background: B.successBg, border: `1px solid ${B.success}20`, marginBottom: 6 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: B.textMuted }}>Vendor: {u.parsed.vendor} Â· Amount: {u.parsed.amount} Â· Date: {u.parsed.date} Â· Category: {u.parsed.category}</div>
                </div>
            ...
            {showSubmit && <div style={{ marginTop: 8, padding: 10, borderRadius: 6, background: B.successBg, color: B.success, fontWeight: 700, fontSize: 13 }}>âœ“ Claim submitted successfully â€” routed to manager for approval</div>}
          </div>
        )}
      </Card>
      <Card>
        <SectionTitle action={<Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag Excel with Employee ID, Type (H&W/L&D), Description, Amount, Currency, Date columns")}>ðŸ“¤ Batch Import Claims</Btn>}>Recent Claims</SectionTitle>
        <Table columns={[
          { label: "ID", render: r => <span style={{ fontWeight: 600, color: B.accent }}>{r.id}</span> },
...
// â”€â”€â”€ APPROVALS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const ApprovalsModule = () => {
  ...
  return (
    <div>
      ...
      {approvals.length === 0 ? (
        <Card style={{ textAlign: "center", padding: 40 }}><div style={{ fontSize: 32, marginBottom: 8 }}>âœ…</div><div style={{ fontSize: 15, fontWeight: 700, color: B.textPrimary }}>All caught up!</div></Card>
      ) : approvals.map(a => (
        <Card key={a.id} style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 13, color: B.textSecondary }}>{a.employee} â€” {a.detail}</div>
            <div style={{ fontSize: 11, color: B.textMuted }}>Submitted {fmtDate(a.submitted)}</div>
          </div>
          <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
            <Btn variant="success" size="sm" onClick={() => setApprovals(p => p.filter(x => x.id !== a.id))}>âœ“ Approve</Btn>
            <Btn variant="danger" size="sm" onClick={() => setApprovals(p => p.filter(x => x.id !== a.id))}>âœ• Reject</Btn>
          </div>
        </Card>
      ))}
    </div>
...
// â”€â”€â”€ SETTINGS / ADMIN (ENHANCED with Reporting Center) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const SettingsModule = () => {
  ...
  const [savedReports, setSavedReports] = useState([
    ...
    { id: "RPT-002", name: "Overtime Compliance â€” March 2026", type: "Compliance", created: "2026-04-05", createdBy: "Admin User", format: "PDF", rows: 42 },
    { id: "RPT-003", name: "Grant Allocation â€” BMGF Fortification", type: "Grant", created: "2026-03-28", createdBy: "Finance Lead", format: "CSV", rows: 156 },
    { id: "RPT-004", name: "Leave Balance Snapshot â€” All Countries", type: "Leave", created: "2026-04-10", createdBy: "Admin User", format: "XLSX", rows: 28 },
    { id: "RPT-005", name: "Turnover Analysis 2025", type: "Turnover", created: "2026-01-15", createdBy: "Admin User", format: "PDF", rows: 14 },
  ]);

  const REPORT_TEMPLATES = [
    { value: "headcount", label: "Headcount Report", desc: "Workforce count by country, department, level, gender, status", fields: ["country", "department", "date_range", "group_by"], icon: "ðŸ‘¥" },
    { value: "compensation", label: "Compensation Report", desc: "Salary, bonus, total comp by entity with currency conversion", fields: ["country", "department", "currency", "date_range"], icon: "ðŸ’°" },
    { value: "leave", label: "Leave & Absence Report", desc: "Leave balances, usage, accruals, carryover by employee", fields: ["country", "department", "leave_type", "date_range"], icon: "ðŸ“…" },
    { value: "compliance", label: "Compliance & Overtime Report", desc: "Labor law violations, overtime hours, rest break gaps", fields: ["country", "date_range", "severity"], icon: "âš–ï¸" },
    { value: "grant", label: "Grant / Donor Allocation Report", desc: "Hours, costs, and FTE allocation by grant/project code", fields: ["grant", "country", "date_range", "currency"], icon: "ðŸ“Š" },
    { value: "turnover", label: "Turnover & Retention Report", desc: "Attrition rate, voluntary/involuntary, tenure analysis", fields: ["country", "department", "date_range"], icon: "ðŸ“‰" },
    { value: "diversity", label: "Diversity & Inclusion Report", desc: "Gender balance, nationality mix, level distribution", fields: ["country", "department", "date_range"], icon: "ðŸŒ" },
    { value: "benefits", label: "Benefits Enrollment Report", desc: "Enrollment status, plan uptake, cost per employee", fields: ["country", "plan_type", "date_range"], icon: "ðŸ¥" },
    { value: "performance", label: "Performance Review Report", desc: "Ratings distribution, calibration, goal completion", fields: ["country", "department", "review_cycle"], icon: "â­" },
    { value: "payroll", label: "Payroll Summary Report", desc: "Gross/net pay, deductions, taxes, multi-currency summary", fields: ["country", "pay_period", "currency"], icon: "ðŸ’µ" },
    { value: "custom", label: "Custom Report Builder", desc: "Select fields, filters, grouping, and calculations from scratch", fields: ["all"], icon: "ðŸ”§" },
  ];
  ...
  const [jobGrades, setJobGrades] = useState([
    { id: "JG-01", grade: "P1", title: "Associate / Entry", category: "Professional", minExp: 0, maxExp: 2, benchmarks: "Market P25â€“P40", factor: "Individual contributor, learning role", points: 100 },
    { id: "JG-02", grade: "P2", title: "Officer", category: "Professional", minExp: 1, maxExp: 4, benchmarks: "Market P40â€“P50", factor: "Independent contributor, applied expertise", points: 200 },
    { id: "JG-03", grade: "P3", title: "Senior Officer", category: "Professional", minExp: 3, maxExp: 7, benchmarks: "Market P50â€“P60", factor: "Specialist, project leadership", points: 300 },
    { id: "JG-04", grade: "P4", title: "Lead / Specialist", category: "Professional", minExp: 5, maxExp: 10, benchmarks: "Market P55â€“P65", factor: "Technical authority, cross-functional", points: 400 },
    { id: "JG-05", grade: "P5", title: "Principal / Expert", category: "Professional", minExp: 8, maxExp: 15, benchmarks: "Market P60â€“P75", factor: "Org-wide expertise, strategy input", points: 500 },
    { id: "JG-06", grade: "M1", title: "Manager", category: "Management", minExp: 5, maxExp: 10, benchmarks: "Market P55â€“P65", factor: "Team leadership, budget accountability", points: 450 },
    { id: "JG-07", grade: "M2", title: "Senior Manager", category: "Management", minExp: 8, maxExp: 15, benchmarks: "Market P60â€“P75", factor: "Department leadership, strategic delivery", points: 550 },
    { id: "JG-08", grade: "M3", title: "Director", category: "Management", minExp: 10, maxExp: 20, benchmarks: "Market P65â€“P80", factor: "Multi-team or country leadership", points: 650 },
    { id: "JG-09", grade: "D1", title: "Senior Director", category: "Executive", minExp: 12, maxExp: 25, benchmarks: "Market P75â€“P90", factor: "Function or regional leadership", points: 800 },
    { id: "JG-10", grade: "VP", title: "Vice President", category: "Executive", minExp: 15, maxExp: 30, benchmarks: "Market P80â€“P95", factor: "Organizational strategy, board-level", points: 950 },
  ]);
  ...
  return (
    <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {REPORT_TEMPLATES.map(r => (
                  <div key={r.value} onClick={() => setReportType(r.value)}
                    ...
                    {reportType === r.value && <span style={{ color: B.accent, fontSize: 16 }}>âœ“</span>}
                  </div>
                ))}
              </div>
            </Card>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {reportType === "custom" && (
                <Card>
                  ...
                  <div style={{ fontSize: 11, color: B.textMuted, marginBottom: 10 }}>{selectedFields.length} fields selected â€” drag to reorder</div>
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
                        {group.fields.map(f => (
                          <button key={f} onClick={() => toggleField(f)} style={{ padding: "4px 10px", borderRadius: 4, border: `1px solid ${selectedFields.includes(f) ? B.accent : B.border}`, background: selectedFields.includes(f) ? B.accentBg : B.white, color: selectedFields.includes(f) ? B.accent : B.textMuted, fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "Arial, sans-serif" }}>
                            {selectedFields.includes(f) ? "âœ“ " : ""}{f}
                          </button>
                        ))}
                      </div>
                    </div>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <Btn variant="primary" style={{ flex: 1 }} onClick={handleGenerate} disabled={!reportType}>
                  {reportGenerated ? "âœ“ Report Generated!" : "ðŸ“Š Generate Report"}
                </Btn>
                <Btn variant="secondary" onClick={() => { if (reportType) setSavedReports(prev => [{ id: `RPT-${Date.now().toString(36)}`, name: `${REPORT_TEMPLATES.find(t => t.value === reportType)?.label || "Custom"} â€” ${new Date().toLocaleDateString()}`, type: reportType, created: new Date().toISOString().split("T")[0], createdBy: "Admin User", format: reportFormat.toUpperCase(), rows: Math.floor(Math.random() * 200 + 20) }, ...prev]); }}>ðŸ’¾ Save</Btn>
              </div>
              {reportGenerated && (
                <div style={{ padding: "10px 14px", borderRadius: 6, background: B.successBg, border: `1px solid ${B.success}20`, fontSize: 12, color: B.success, fontWeight: 700 }}>
                  âœ“ Report generated successfully â€” {reportFormat.toUpperCase()} file ready for download ({Math.floor(Math.random() * 200 + 20)} rows, {reportCountry === "ALL" ? "14 countries" : COUNTRIES.find(c => c.code === reportCountry)?.name})
                </div>
              )}
            </div>
          </div>
        ...
        <Card>
          ...
          <Table columns={[
            ...
            { label: "Actions", render: r => (
              <div style={{ display: "flex", gap: 4 }}>
                <Btn variant="ghost" size="sm" onClick={() => alert(`Downloading ${r.name}`)}>â¬‡</Btn>
                <Btn variant="ghost" size="sm" onClick={() => alert(`Re-running ${r.name}`)}>â†»</Btn>
                <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => setSavedReports(prev => prev.filter(x => x.id !== r.id))}>ðŸ—‘</Btn>
              </div>
            )},
          ]} data={savedReports} />
        </Card>
      ...
      {/* â•â•â• SALARY STRUCTURES (Drag & Drop Reorder) â•â•â• */}
      {tab === "salary" && (
        <div>
                  ...
                  {salaryStructures.map((ss, i) => {
                    ...
                    return (
                      <tr key={ss.id} draggable onDragStart={() => setDragIdx(i)} onDragOver={ev => ev.preventDefault()}
                        ...
                        <td style={{ padding: "8px 6px", borderBottom: `1px solid ${B.borderLight}`, color: B.textMuted, cursor: "grab", fontSize: 14 }}>â‹®â‹®</td>
                        ...
                        <td style={{ padding: "8px 10px", borderBottom: `1px solid ${B.borderLight}` }}>
                          <div style={{ display: "flex", gap: 4 }}>
                            <Btn variant="ghost" size="sm" onClick={() => { setSalaryForm({ ...ss }); setShowSalaryEdit(ss.id); }}>âœï¸</Btn>
                            {empCount === 0 && <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => setSalaryStructures(prev => prev.filter(s => s.id !== ss.id))}>ðŸ—‘</Btn>}
                          </div>
                        </td>
                      </tr>
                    );
          ...
          <Modal open={!!showSalaryEdit} onClose={() => setShowSalaryEdit(null)} title={showSalaryEdit === "new" ? "Add Salary Band" : `Edit: ${salaryForm.level}`} width={520}>
            ...
            {salaryForm.min > 0 && salaryForm.max > 0 && <div style={{ marginTop: 10, padding: 8, borderRadius: 6, background: B.accentBg, fontSize: 12, color: B.textSecondary }}>Spread: {Math.round((salaryForm.max - salaryForm.min) / salaryForm.min * 100)}% Â· Midpoint penetration range: {fmt(salaryForm.min, salaryForm.currency)} â€” {fmt(salaryForm.max, salaryForm.currency)}</div>}
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 12 }}>
              ...
              }}>ðŸ’¾ {showSalaryEdit === "new" ? "Create" : "Save"}</Btn>
            </div>
          </Modal>
        </div>
      )}

      {/* â•â•â• JOB EVALUATION GRADING â•â•â• */}
      {tab === "grades" && (
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                ...
                <tbody>{jobGrades.map((jg, i) => {
                  ...
                  return (
                    <tr key={jg.id} onMouseEnter={ev => ev.currentTarget.style.background = B.bgHover} onMouseLeave={ev => ev.currentTarget.style.background = "transparent"}>
                      ...
                      <td style={{ padding: "8px 10px", borderBottom: `1px solid ${B.borderLight}` }}>{jg.minExp}â€“{jg.maxExp} yrs</td>
                      ...
                      <td style={{ padding: "8px 10px", borderBottom: `1px solid ${B.borderLight}` }}>
                        <div style={{ display: "flex", gap: 4 }}>
                          <Btn variant="ghost" size="sm" onClick={() => { setGradeForm({ ...jg }); setShowGradeEdit(jg.id); }}>âœï¸</Btn>
                          {empCount === 0 && <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => setJobGrades(prev => prev.filter(g => g.id !== jg.id))}>ðŸ—‘</Btn>}
                        </div>
                      </td>
                    </tr>);
                })}</tbody>
          ...
          <Modal open={!!showGradeEdit} onClose={() => setShowGradeEdit(null)} title={showGradeEdit === "new" ? "Add Job Grade" : `Edit: ${gradeForm.grade}`} width={560}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <div style={{ gridColumn: "1 / -1" }}><label style={{ fontSize: 10, fontWeight: 700, color: B.textMuted, textTransform: "uppercase", letterSpacing: 0.5, display: "block", marginBottom: 4, fontFamily: "Arial, sans-serif" }}>Market Benchmark</label>
                <input value={gradeForm.benchmarks} onChange={ev => setGradeForm(p => ({ ...p, benchmarks: ev.target.value }))} placeholder="e.g. Market P50â€“P65" style={{ width: "100%", padding: 9, borderRadius: 8, border: `1px solid ${B.border}`, fontSize: 13, fontFamily: "Arial, sans-serif", boxSizing: "border-box" }} /></div>
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 12 }}>
              ...
              }}>ðŸ’¾ {showGradeEdit === "new" ? "Create" : "Save"}</Btn>
            </div>
          </Modal>
        </div>
      )}

      {/* â•â•â• EDIT HISTORICAL RECORDS â•â•â• */}
      {tab === "history" && (
        <div>
          <div style={{ padding: "10px 14px", borderRadius: 8, background: B.warningBg, border: `1px solid ${B.warning}20`, marginBottom: 14, fontSize: 12, color: B.textSecondary }}>
            <strong>Historical Record Editing</strong> â€” Search for any employee and modify their effective-dated records (compensation, title, level, department, status). All edits create an audit trail entry with the original value, new value, reason, and administrator identity.
          </div>
          ...
          {EMPLOYEES.filter(e => historySearch.length >= 2 && `${e.first} ${e.last} ${e.id}`.toLowerCase().includes(historySearch.toLowerCase())).slice(0, 5).map(emp => (
            <Card key={emp.id} style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                ...
                <div><div style={{ fontSize: 13, fontWeight: 700 }}>{emp.first} {emp.last}</div><div style={{ fontSize: 11, color: B.textMuted }}>{emp.id} Â· {emp.title} Â· {emp.flag} {emp.countryName}</div></div>
              </div>
              ...
              {emp.employmentHistory.slice(0, 8).map((h, i) => {
                ...
                return (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 10px", borderRadius: 6, background: B.bgHover, marginBottom: 3, fontSize: 11 }}>
                    ...
                    <Btn variant="ghost" size="sm" onClick={() => { setHistoryForm({ field: h.field, oldValue: h.oldValue, newValue: h.newValue, effectiveDate: h.effectiveDate, reason: h.reason, empId: emp.id, empName: `${emp.first} ${emp.last}`, idx: i }); setShowHistoryEdit(true); }}>âœï¸</Btn>
                  </div>
                );
              })}
          ...
          <Modal open={!!showHistoryEdit} onClose={() => setShowHistoryEdit(null)} title={historyForm.idx === "new" ? `Add Record â€” ${historyForm.empName}` : `Edit Record â€” ${historyForm.empName}`} width={520}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <div style={{ gridColumn: "1 / -1" }}><label style={{ fontSize: 10, fontWeight: 700, color: B.textMuted, textTransform: "uppercase", letterSpacing: 0.5, display: "block", marginBottom: 4, fontFamily: "Arial, sans-serif" }}>Reason / Justification</label>
                <input value={historyForm.reason} onChange={ev => setHistoryForm(p => ({ ...p, reason: ev.target.value }))} placeholder="e.g. Correction â€” original entry error" style={{ width: "100%", padding: 9, borderRadius: 8, border: `1px solid ${B.border}`, fontSize: 13, fontFamily: "Arial, sans-serif", boxSizing: "border-box" }} /></div>
            </div>
            <div style={{ marginTop: 10, padding: 10, borderRadius: 6, background: `${B.charcoal}06`, border: `1px solid ${B.charcoal}12`, fontSize: 11, color: B.textMuted, fontFamily: "monospace" }}>
              ...
              <div><strong>Field:</strong> {historyForm.field || "â€”"} Â· <strong>Effective:</strong> {historyForm.effectiveDate || "â€”"}</div>
              <div><strong>Value:</strong> {historyForm.oldValue || "â€”"} â†’ {historyForm.newValue || "â€”"}</div>
              <div><strong>Modified by:</strong> Admin Â· <strong>Timestamp:</strong> {new Date().toISOString()}</div>
            </div>
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 12 }}>
              <Btn variant="secondary" onClick={() => setShowHistoryEdit(null)}>Cancel</Btn>
              <Btn variant="primary" onClick={() => { setShowHistoryEdit(null); alert(`Historical record ${historyForm.idx === "new" ? "added" : "updated"} for ${historyForm.empName}. Audit entry created with full before/after values.`); }}>ðŸ’¾ {historyForm.idx === "new" ? "Add Record" : "Save Edit"}</Btn>
            </div>
          </Modal>
        </div>
      )}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {COUNTRIES.map(c => (
            <div key={c.code} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 6, background: B.bgHover, border: `1px solid ${B.border}` }}>
              ...
              <div style={{ flex: 1 }}><div style={{ fontWeight: 700, fontSize: 13 }}>{c.name}</div><div style={{ fontSize: 11, color: B.textMuted }}>{c.locale} Â· {c.currency}</div></div>
...
// â”€â”€â”€ COMPENSATION PLANNING MODULE (ACR: COLA + Merit + Bonus Â· Access Control) â”€
  ...
  return (
    <div>
      {isHR && (<div style={{display:"flex",alignItems:"center",gap:10,padding:"8px 14px",borderRadius:6,background:`${B.charcoal}08`,border:`1px solid ${B.charcoal}15`,marginBottom:14}}>
        <span style={{fontSize:14}}>ðŸ”’</span>
        <span style={{flex:1,fontSize:12,color:B.textSecondary}}><strong>Restricted Module</strong> â€” HR Admin + Superuser have full access. Managers see only their team worksheet when permissioned.</span>
        <Btn variant="secondary" size="sm" onClick={()=>setShowPermModal(true)}>ðŸ‘¥ Manage Access ({permUsers.length})</Btn>
      </div>)}
      <Tabs tabs={[
      ...
      {tab==="acr"&&(<div>
        <Card style={{marginBottom:14,borderTop:`4px solid ${B.accent}`}}>
          <SectionTitle>ACR Pool Configuration â€” COLA Â· Merit Â· Bonus</SectionTitle>
        ...
        <Card>
          <SectionTitle>Merit Matrix (Performance Ã— Compa-Ratio)</SectionTitle>
          <div style={{overflowX:"auto"}}><table style={{width:"100%",borderCollapse:"collapse",fontSize:12,fontFamily:"Arial, sans-serif",textAlign:"center"}}>
            <thead><tr><th style={{padding:8,background:B.bgHover,borderBottom:`2px solid ${B.teal}`,fontSize:9,letterSpacing:0.6,textTransform:"uppercase",color:B.textSecondary}}>Rating \ CR</th>
              {["< 0.85","0.85â€“0.95","0.95â€“1.05","1.05â€“1.15","> 1.15"].map(h=><th key={h} style={{padding:8,background:B.bgHover,borderBottom:`2px solid ${B.teal}`,fontSize:9,color:B.textSecondary}}>{h}</th>)}
            </tr></thead>
            <tbody>{[{r:"â‰¥ 4.5 Exceptional",v:[6,5,4.5,4,3]},{r:"4.0â€“4.4 Exceeds",v:[5,4,3.5,3,2]},{r:"3.5â€“3.9 Meets+",v:[4,3.5,3,2.5,1.5]},{r:"3.0â€“3.4 Meets",v:[3,2.5,2,1.5,0]},{r:"< 3.0 Developing",v:[0,0,0,0,0]}].map((row,ri)=>(
              <tr key={ri}><td style={{padding:8,fontWeight:700,textAlign:"left",borderBottom:`1px solid ${B.borderLight}`,fontSize:11}}>{row.r}</td>
                {row.v.map((val,vi)=><td key={vi} style={{padding:8,borderBottom:`1px solid ${B.borderLight}`}}><div style={{display:"inline-flex",padding:"4px 10px",borderRadius:4,background:val>=4?B.successBg:val>=2?`${B.teal}12`:val>0?B.warningBg:B.bgHover,color:val>=4?B.success:val>=2?B.teal:val>0?B.orange:B.textMuted,fontWeight:700}}>{val>0?`${val}%`:"â€”"}</div></td>)}
              </tr>))}</tbody>
          </table></div>
        </Card>
      </div>)}
      ...
      {tab==="bands"&&(<Card>
        ...
        <Table columns={[
          ...
          {label:"Avg CR",render:r=>{const emps=EMPLOYEES.filter(e=>e.level===r.level);const cr=emps.length?(emps.reduce((s,e)=>s+e.salary,0)/emps.length/r.mid).toFixed(2):"â€”";return cr!=="â€”"?<Badge color={cr>=0.95&&cr<=1.05?B.success:B.warning} bg={cr>=0.95?B.successBg:B.warningBg}>{cr}</Badge>:"â€”";}},
        ]} data={BANDS}/>
      </Card>)}
      ...
      {tab==="planning"&&(<div>
        <div style={{display:"flex",gap:8,marginBottom:12,flexWrap:"wrap",fontSize:12,alignItems:"center"}}>
          ...
          <Badge color={totals.totalACRCost<=(totals.colaBudget+totals.meritBudget+totals.bonusBudget)?B.success:B.danger} bg={totals.totalACRCost<=(totals.colaBudget+totals.meritBudget+totals.bonusBudget)?B.successBg:B.dangerBg}>Total: {fmt(totals.totalACRCost,"CAD")} {totals.totalACRCost<=(totals.colaBudget+totals.meritBudget+totals.bonusBudget)?"âœ“ Within Budget":"âš  Over"}</Badge>
          <Btn variant="secondary" size="sm" style={{marginLeft:"auto"}} onClick={()=>alert("Batch upload: drag an Excel file with Employee ID, COLA%, Merit%, Bonus% columns to bulk-update the worksheet.")}>ðŸ“¤ Batch Upload Comp Data</Btn>
        </div>
        <div style={{overflowX:"auto",borderRadius:6,border:`1px solid ${B.border}`}}>
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:10,fontFamily:"Arial, sans-serif"}}>
            <thead><tr style={{background:B.bgHover}}>
              {["Employee","ðŸŒ","Lvl","Current","CR","Perf","COLA%","COLA$","Merit%","Merit$","Bonus%","Bonus$","â†‘%","New Base","Flags","Status"].map(h=>(
            ...
            <tbody>{worksheetData.map((r,i)=>(
              <tr key={i} onMouseEnter={ev=>ev.currentTarget.style.background=B.bgHover} onMouseLeave={ev=>ev.currentTarget.style.background="transparent"}>
                ...
                <td style={{padding:"5px 3px",borderBottom:`1px solid ${B.borderLight}`}}>{r.flags.length>0?r.flags.map((f,fi)=><Badge key={fi} color={B.danger} bg={B.dangerBg} style={{marginRight:2,fontSize:7}}>{f}</Badge>):<span style={{color:B.success,fontSize:9}}>âœ“</span>}</td>
      ...
      {tab==="scenarios"&&(<Card>
        ...
        <Table columns={[
          ...
          {label:"Equity Î”",render:r=><span style={{color:r.equityImpact<0?B.success:B.danger,fontWeight:700}}>{r.equityImpact>0?"+":""}{r.equityImpact}%</span>},
        ]} data={scenarios}/>
      </Card>)}
      ...
      {tab==="statements"&&(<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
        {EMPLOYEES.slice(0,6).map(e=>{const bv=Math.round(e.salary*0.22);const al=e.hwAllowance.total+e.ldAllowance.total;const t=e.salary+e.bonus+bv+al;return(<Card key={e.id} style={{borderLeft:`4px solid ${B.accent}`}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:8}}><Avatar name={`${e.first} ${e.last}`} size={28}/><div><div style={{fontWeight:700,fontSize:12}}>{e.first} {e.last}</div><div style={{fontSize:10,color:B.textMuted}}>{e.title} Â· {e.flag}</div></div></div>
          ...
          <Btn variant="secondary" size="sm" style={{width:"100%",marginTop:6}}onClick={() => alert(`Total Rewards Statement PDF generated for ${e.first} ${e.last}`)}>ðŸ“„ PDF</Btn>
        </Card>);})}
      </div>)}
      ...
      {tab==="benchmarks"&&(<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
        ...
        <Card><SectionTitle>Benchmark Sources</SectionTitle>
          {[{n:"Birches Group â€” INGO Global",u:"Jan 2026",s:"Active"},{n:"Mercer ICS (COLA)",u:"Mar 2026",s:"Active"},{n:"PayScale Tech",u:"Feb 2026",s:"Active"},{n:"WTW",u:"Nov 2025",s:"Renewal Due"}].map((s,i)=>(
      ...
      {/* ACCESS MODAL */}
      <Modal open={showPermModal} onClose={()=>setShowPermModal(false)} title="Comp Planning â€” Access Management" width={650}>
...
const SurveyModule = ({ employee: empProp } = {}) => {
  ...
  const SURVEYS = [
    ...
    { id: "SRV-DEC-360", name: "2025 Annual 360Â° Feedback", type: "360Â°", status: "Closed", responses: 26, total: 28, startDate: "2025-11-01", endDate: "2025-12-15", anonymous: true, threshold: 3, engagement: 72, nps: 35 },
  ...
  const ENGAGEMENT_DATA = {
    ...
    byTenure: { "< 1 yr": 82, "1â€“3 yr": 76, "3â€“5 yr": 72, "5+ yr": 78 },
    ...
    <div style={{ marginBottom: 10 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {benchmark && <span style={{ fontSize: 10, color: score >= benchmark ? B.success : B.danger }}>{score >= benchmark ? "â–²" : "â–¼"} vs {benchmark}% benchmark</span>}
        </div>
      </div>
  ...
  return (
    <div>
      ...
      {/* â•â•â•â•â•â•â•â• ENGAGEMENT DASHBOARD â•â•â•â•â•â•â•â• */}
      {tab === "dashboard" && (
        <div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px,1fr))", gap: 10, marginBottom: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            ...
            <Card>
              ...
              <div style={{ marginTop: 12, padding: 10, borderRadius: 6, background: B.accentBg, border: `1px solid ${B.accent}20`, fontSize: 12, color: B.textSecondary }}>
                <strong>NI Score: {ENGAGEMENT_DATA.overall}%</strong> â€” Above the international development benchmark by {ENGAGEMENT_DATA.overall - ENGAGEMENT_DATA.benchmarks["int'l dev"]} points.
              </div>
            </Card>
            <Card>
            ...
            <Card>
              ...
              {[
                ...
                <div key={i} style={{ padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                    <span style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>{f.area} â€” {f.score}%</span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 14 }}>
            <Card>
              ...
              <div onDragOver={ev => { ev.preventDefault(); setPyDragOver(true); }} onDragLeave={() => setPyDragOver(false)} onDrop={handlePYDrop}
                ...
                {priorYearData ? (
                  <div><div style={{ fontSize: 28, marginBottom: 6 }}>âœ…</div><div style={{ fontSize: 13, fontWeight: 700, color: B.success }}>2025 Results Loaded</div><div style={{ fontSize: 11, color: B.textMuted, marginTop: 4 }}>Engagement: {priorYearData.engagement}% Â· {priorYearData.totalResponses} responses Â· {priorYearData.responseRate}% rate</div></div>
                ) : (
                  <div><div style={{ fontSize: 28, marginBottom: 6 }}>ðŸ“Š</div><div style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>Drag & drop prior year results</div><div style={{ fontSize: 11, color: B.textMuted, marginTop: 4 }}>.xlsx, .csv, or .pdf â€” columns auto-mapped</div></div>
                )}
              </div>
            </Card>
            <Card style={{ opacity: priorYearData ? 1 : 0.4, pointerEvents: priorYearData ? "auto" : "none" }}>
              <SectionTitle>{priorYearData ? `Year-over-Year (${priorYearData.year} â†’ 2026)` : "YoY Comparison (import to unlock)"}</SectionTitle>
              {priorYearData ? (
                <div>
      ...
      {/* â•â•â•â•â•â•â•â• SURVEYS LIST â•â•â•â•â•â•â•â• */}
      {tab === "surveys" && (
        <div>
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 14, gap: 6 }}>
            <Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag Excel with Survey ID, Employee ID, Question ID, Response, Score columns for bulk survey result import")}>ðŸ“¤ Batch Import Results</Btn>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
                    ...
                    {s.anonymous && <Badge color={B.purple} bg={`${B.purple}12`}>Anonymous (â‰¥{s.threshold})</Badge>}
                  </div>
                  <div style={{ fontSize: 12, color: B.textMuted }}>{fmtDate(s.startDate)} â€“ {fmtDate(s.endDate)} Â· {s.responses}/{s.total} responses ({Math.round(s.responses / s.total * 100)}%)</div>
                </div>
                <div style={{ display: "flex", gap: 6 }}>
                  {s.status === "Active" && <Btn variant="secondary" size="sm" onClick={() => alert('Reminder emails sent to non-respondents')}>ðŸ“§ Send Reminder</Btn>}
                  <Btn variant="secondary" size="sm" onClick={() => setTab("dashboard")}>ðŸ“Š Results</Btn>
                </div>
              </div>
            </Card>
          ))}
      ...
      {/* â•â•â•â•â•â•â•â• HEATMAPS â•â•â•â•â•â•â•â• */}
      {tab === "heatmaps" && (
        <div>
          ...
          <Card>
            <SectionTitle>Engagement Heatmap â€” {heatmapDim === "department" ? "Department" : heatmapDim === "country" ? "Country" : "Tenure Band"}</SectionTitle>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, fontFamily: "Arial, sans-serif" }}>
                <thead><tr style={{ background: B.bgHover }}>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 12, fontSize: 11, color: B.textMuted, alignItems: "center" }}>
              <span>Legend:</span>
              {[{ label: "â‰¥80 Strong", color: B.success }, { label: "70â€“79 Good", color: B.blue }, { label: "60â€“69 Caution", color: B.warning }, { label: "<60 Critical", color: B.danger }].map(l => (
      ...
      {/* â•â•â•â•â•â•â•â• LEAD DRIVERS â•â•â•â•â•â•â•â• */}
      {tab === "drivers" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.accent}` }}>
            ...
            {[
              ...
              <div key={d.key} style={{ padding: "12px 14px", borderRadius: 8, background: B.bgHover, marginBottom: 8 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>{d.label} â€” {d.score}%</div>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, color: B.textMuted }}>Impact: {d.impact} Â· Current: {d.current}% Â· Gap to target: {d.gap}pts</div>
                </div>
      ...
      {/* â•â•â•â•â•â•â•â• COMMENT ANALYTICS â•â•â•â•â•â•â•â• */}
      {tab === "comments" && (
        <div>
          <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card>
              ...
              <div style={{ marginTop: 12, padding: 10, borderRadius: 6, background: B.bgHover, fontSize: 12, color: B.textSecondary }}>
                <strong>Sentiment Split:</strong> 58% positive Â· 35% negative Â· 7% neutral
              </div>
            </Card>
            <Card>
      ...
      {/* â•â•â•â•â•â•â•â• PREDICTIVE / TURNOVER RISK â•â•â•â•â•â•â•â• */}
      {tab === "predictive" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.danger}` }}>
            ...
            {ENGAGEMENT_DATA.turnoverRisk.map((t, i) => (
              <div key={i} style={{ padding: "12px 14px", borderRadius: 8, background: t.risk === "High" ? B.dangerBg : B.warningBg, border: `1px solid ${t.risk === "High" ? B.danger : B.warning}20`, marginBottom: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  ...
                  <Badge color={t.risk === "High" ? B.danger : B.orange} bg={t.risk === "High" ? B.dangerBg : B.warningBg}>{t.risk} Risk â€” {t.score}%</Badge>
                </div>
          ...
          <Card>
            <SectionTitle>Engagement â†’ Business Outcome Correlation</SectionTitle>
            {[
      ...
      {/* â•â•â•â•â•â•â•â• SURVEY BUILDER (Enhanced with Drag-Drop) â•â•â•â•â•â•â•â• */}
      {tab === "create" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <Card>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ marginLeft: "auto", fontSize: 11, color: B.textMuted }}>Threshold: â‰¥5 per group</span>
                </div>
              </div>
            </Card>
            ...
            <Card style={{ borderTop: `4px solid ${B.blue}` }}>
              ...
              <div onDragOver={ev => { ev.preventDefault(); setQDragOver(true); }} onDragLeave={() => setQDragOver(false)} onDrop={handleQDrop}
                ...
                <div style={{ fontSize: 12, color: B.textMuted, marginTop: 4 }}>Supports .xlsx, .csv, .docx, .pdf â€” one question per row/line</div>
              ...
              {uploadedQuestions.length > 0 && (
                <div style={{ marginTop: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                    <Badge color={B.success} bg={B.successBg}>âœ“ {uploadedQuestions.length} QUESTIONS PARSED</Badge>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <Card style={{ borderTop: `4px solid ${B.success}` }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <Btn variant="primary" style={{ flex: 1 }} onClick={() => alert('Survey launched! Invitations sent to selected participants.')}>ðŸš€ Launch Survey</Btn>
                <Btn variant="secondary" onClick={() => alert('Survey draft saved')}>ðŸ’¾ Save Draft</Btn>
                <Btn variant="secondary" onClick={() => alert('Opening survey preview...')}>ðŸ‘ Preview</Btn>
              </div>
            </Card>
          </div>
        </div>
...
// â”€â”€â”€ AUDIT LOG DATA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const AUDIT_LOG = [
  ...
  { id: "AUD-0002", timestamp: "2026-04-23T13:15:44Z", user: "Admin User", role: "HR Admin", action: "Created", target: "Employee: NI-01028", detail: "New hire onboarding â€” Maria Santos, Philippines office", ip: "203.0.113.88", location: "Manila, PH", session: "SES-4b7c1e" },
  { id: "AUD-0003", timestamp: "2026-04-23T11:05:22Z", user: "Sarah Chen", role: "Manager", action: "Approved", target: "Leave Request: LR-002", detail: "Lars MÃ¼ller â€” Sick Leave 2 days approved", ip: "192.0.2.17", location: "Ottawa, CA", session: "SES-9d2e5f" },
  ...
  { id: "AUD-0005", timestamp: "2026-04-22T17:22:15Z", user: "Admin User", role: "HR Admin", action: "Modified", target: "Employee: NI-01005 Compensation", detail: "Oliver Wright salary change GBP 62,000 â†’ 68,000", ip: "198.51.100.55", location: "London, GB", session: "SES-1c8d4a" },
  ...
  { id: "AUD-0007", timestamp: "2026-04-22T14:05:33Z", user: "Priya Patel", role: "Manager", action: "Submitted", target: "Leave Request: LR-001", detail: "Annual Leave Apr 28 â€“ May 2 submitted for approval", ip: "93.184.216.34", location: "Rome, IT", session: "SES-7f3a9b" },
  ...
  { id: "AUD-0009", timestamp: "2026-04-21T16:44:12Z", user: "Admin User", role: "HR Admin", action: "Generated", target: "Verification Letter: NI-01010", detail: "Employment letter for Elena Volkov â€” immigration purpose", ip: "198.51.100.55", location: "Ottawa, CA", session: "SES-1c8d4a" },
  ...
  { id: "AUD-0011", timestamp: "2026-04-20T09:05:40Z", user: "Grant Carioni", role: "Superuser", action: "Formatting", target: "System: Dashboard Layout", detail: "Modified dashboard grid â€” added Grant Allocation widget to default view", ip: "198.51.100.42", location: "Ottawa, CA", session: "SES-8a3f2d" },
  { id: "AUD-0012", timestamp: "2026-04-19T14:28:19Z", user: "System", role: "System", action: "Sync", target: "Integration: Workable ATS", detail: "Auto-sync completed â€” 7 requisitions, 169 candidates updated", ip: "10.0.0.1", location: "Cloud (AWS ca-central-1)", session: "SES-SYSTEM" },
];

// â”€â”€â”€ SUPERUSER MODULE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const SuperuserModule = () => {
  ...
  const [addOnModules, setAddOnModules] = useState([
    { id: "ADDON-001", name: "Expense Management", desc: "Travel and expense claims with receipt scanning, per-diem rules, and multi-currency reimbursement", icon: "ðŸ§¾", status: "active", assignedTo: "all", assignedUsers: [], assignedGroups: [], created: "2026-02-15" },
    { id: "ADDON-002", name: "Asset & Equipment Tracker", desc: "Assign, track, and recover organizational assets (laptops, phones, vehicles) per employee", icon: "ðŸ’»", status: "active", assignedTo: "groups", assignedUsers: [], assignedGroups: ["IT & Digital", "Operations"], created: "2026-03-01" },
    { id: "ADDON-003", name: "Volunteer Management", desc: "Onboard, schedule, track hours, and manage credentials for volunteers and short-term consultants", icon: "ðŸ¤", status: "active", assignedTo: "groups", assignedUsers: [], assignedGroups: ["Programs"], created: "2026-01-20" },
    { id: "ADDON-004", name: "Travel & Security Clearance", desc: "Travel request approvals, security briefings, field travel risk assessments, and emergency contact sync", icon: "âœˆï¸", status: "active", assignedTo: "all", assignedUsers: [], assignedGroups: [], created: "2026-03-10" },
    { id: "ADDON-005", name: "Document Vault (e-Signature)", desc: "Secure document storage with e-signature workflows, version control, and retention policy enforcement", icon: "ðŸ”", status: "active", assignedTo: "individuals", assignedUsers: ["Sarah Chen", "Marcus Johnson", "Priya Patel", "Grant Carioni"], assignedGroups: [], created: "2026-04-01" },
    { id: "ADDON-006", name: "Mentorship & Coaching Platform", desc: "Match mentors with mentees, schedule sessions, track goals, and collect feedback", icon: "ðŸŽ“", status: "draft", assignedTo: "none", assignedUsers: [], assignedGroups: [], created: "2026-04-18" },
    { id: "ADDON-007", name: "Workplace Safety & Incident Reporting", desc: "Report workplace incidents, near-misses, and safety concerns with investigation workflows", icon: "âš ï¸", status: "active", assignedTo: "groups", assignedUsers: [], assignedGroups: ["Operations", "Programs", "Technical"], created: "2026-02-01" },
    { id: "ADDON-008", name: "Internal Job Board & Mobility", desc: "Post internal opportunities, allow employees to express interest, and track internal transfers", icon: "ðŸ”„", status: "active", assignedTo: "all", assignedUsers: [], assignedGroups: [], created: "2026-01-15" },
  ]);
  const [newAddOn, setNewAddOn] = useState({ name: "", desc: "", icon: "ðŸ“¦" });
  ...
  const [securityRoles, setSecurityRoles] = useState([
    { id: "ROLE-001", name: "Superuser", desc: "Full system access â€” all modules, all data, all configuration", level: "System", users: 1, permissions: { people: "Full", comp: "Full", surveys: "Full", performance: "Full", lms: "Full", time: "Full", admin: "Full", reports: "Full" }, locked: true },
    { id: "ROLE-002", name: "HR Admin", desc: "Full HR access â€” employee records, compensation, onboarding, reporting", level: "Global", users: 1, permissions: { people: "Full", comp: "Full", surveys: "Full", performance: "Full", lms: "Admin", time: "Full", admin: "Limited", reports: "Full" }, locked: false },
    { id: "ROLE-003", name: "Country HR Admin", desc: "HR access scoped to a specific country/entity â€” manages local staff", level: "Country", users: 1, permissions: { people: "Country", comp: "Country", surveys: "Country", performance: "Country", lms: "Country", time: "Country", admin: "None", reports: "Country" }, locked: false },
    { id: "ROLE-004", name: "Manager", desc: "Access to direct reports â€” reviews, leave approvals, team analytics", level: "Team", users: 2, permissions: { people: "Team", comp: "View Own", surveys: "Participate", performance: "Team", lms: "View", time: "Team", admin: "None", reports: "Team" }, locked: false },
    { id: "ROLE-005", name: "Employee", desc: "Self-service â€” own profile, leave requests, learning, feedback", level: "Self", users: 20, permissions: { people: "Self", comp: "View Own", surveys: "Participate", performance: "Self", lms: "Learner", time: "Self", admin: "None", reports: "None" }, locked: false },
    { id: "ROLE-006", name: "Grants Finance", desc: "Financial oversight â€” grant allocations, compensation cost views, budget reports", level: "Functional", users: 1, permissions: { people: "View", comp: "View", surveys: "None", performance: "None", lms: "None", time: "View", admin: "None", reports: "Finance" }, locked: false },
    { id: "ROLE-007", name: "L&D Administrator", desc: "Learning management â€” course admin, content uploads, learning analytics", level: "Functional", users: 0, permissions: { people: "View", comp: "None", surveys: "None", performance: "View", lms: "Full", time: "None", admin: "None", reports: "LMS" }, locked: false },
    ...
    <div>
      ...
      <div style={{ padding: "10px 16px", borderRadius: 6, background: `linear-gradient(135deg, ${B.charcoal}, ${B.grey})`, color: "#fff", marginBottom: 16, display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 11, opacity: 0.8 }}>Full system access â€” feature management, formatting, audit logs, user administration. All actions are logged.</div>
        </div>
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", gap: 12, fontSize: 11, color: B.textMuted, flexWrap: "wrap" }}>
                        <span>ðŸ‘¤ {a.user} <Badge color={a.role === "Superuser" ? B.yellow : a.role === "HR Admin" ? B.accent : a.role === "System" ? B.textMuted : B.blue} bg={`${a.role === "Superuser" ? B.yellow : B.textMuted}14`} style={{ fontSize: 9, marginLeft: 4 }}>{a.role}</Badge></span>
                        <span>ðŸŒ {a.ip}</span>
                        <span>ðŸ“ {a.location}</span>
                        <span>ðŸ”‘ {a.session}</span>
                      </div>
                    </div>
                  </div>
                </Card>
      ...
      {/* â•â•â• FEATURE MANAGEMENT â•â•â• */}
      {tab === "features" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card>
      ...
      {/* â•â•â• ADD-ON MODULES (Assign to individuals, groups, or all) â•â•â• */}
      {tab === "addons" && (
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          ...
          <Card style={{ marginBottom: 14, borderTop: `4px solid ${B.teal}` }}>
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "flex-end", flexWrap: "wrap" }}>
              <div style={{ flex: "0 0 50px" }}>
                ...
                <Select value={newAddOn.icon} onChange={v => setNewAddOn(p => ({ ...p, icon: v }))} options={["ðŸ“¦","ðŸ§¾","ðŸ’»","ðŸ¤","âœˆï¸","ðŸ”","ðŸŽ“","âš ï¸","ðŸ”„","ðŸ“‹","ðŸ¥","ðŸŽ¯","ðŸ“ž","ðŸ—‚ï¸","ðŸŒ"].map(i => ({ value: i, label: i }))} />
              </div>
              ...
              <Btn variant="primary" onClick={() => { if (newAddOn.name) { setAddOnModules(prev => [...prev, { id: `ADDON-${Date.now().toString(36)}`, ...newAddOn, status: "draft", assignedTo: "none", assignedUsers: [], assignedGroups: [], created: new Date().toISOString().split("T")[0] }]); setNewAddOn({ name: "", desc: "", icon: "ðŸ“¦" }); } }}>+ Create Module</Btn>
            </div>
          </Card>
            ...
            {addOnModules.map(mod => (
              <Card key={mod.id} style={{ borderLeft: `4px solid ${mod.status === "active" ? B.success : B.textMuted}` }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: B.textMuted }}>{mod.id} Â· Created {fmtDate(mod.created)}</div>
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 4 }}>
                ...
                <div style={{ padding: "8px 10px", borderRadius: 6, background: B.bgHover, marginBottom: 8 }}>
                  ...
                  {mod.assignedTo === "none" && (
                    <span style={{ fontSize: 11, color: B.textMuted }}>Not yet assigned â€” module is in draft</span>
                  )}
                </div>

                {/* Actions */}
                <div style={{ display: "flex", gap: 6 }}>
                  <Btn variant="primary" size="sm" onClick={() => setShowAddOnAssign(mod.id)}>ðŸ‘¥ Assign / Reassign</Btn>
                  {mod.status === "draft" ? (
                    <Btn variant="success" size="sm" onClick={() => setAddOnModules(prev => prev.map(m => m.id === mod.id ? { ...m, status: "active" } : m))}>âœ“ Activate</Btn>
                  ) : (
                    <Btn variant="secondary" size="sm" onClick={() => setAddOnModules(prev => prev.map(m => m.id === mod.id ? { ...m, status: "draft" } : m))}>â¸ Deactivate</Btn>
                  )}
                  <Btn variant="ghost" size="sm" style={{ color: B.danger, marginLeft: "auto" }} onClick={() => setAddOnModules(prev => prev.filter(m => m.id !== mod.id))}>ðŸ—‘</Btn>
                </div>
              </Card>
            ))}
          </div>
          ...
          <Modal open={!!showAddOnAssign} onClose={() => { setShowAddOnAssign(null); setAssignTarget("all"); setAssignDepts([]); setAssignIndividuals([]); }} title={`Assign Module: ${addOnModules.find(m => m.id === showAddOnAssign)?.name || ""}`} width={620}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", gap: 6 }}>
                {[{ v: "all", l: "ðŸŒ All Staff", d: `All ${EMPLOYEES.length} employees` }, { v: "groups", l: "ðŸ¢ Departments / Groups", d: "Select specific departments" }, { v: "individuals", l: "ðŸ‘¤ Individual Employees", d: "Pick specific people" }].map(opt => (
            ...
            {assignTarget === "groups" && (
              <div style={{ marginBottom: 14 }}>
                ...
                <div style={{ fontSize: 11, color: B.textMuted, marginTop: 6 }}>Selected: {assignDepts.length} departments Â· {assignDepts.reduce((s, d) => s + EMPLOYEES.filter(e => e.department === d).length, 0)} employees</div>
              </div>
            )}
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
              ...
              }}>âœ“ Apply Assignment</Btn>
            </div>
          </Modal>
        </div>
      )}

      {/* â•â•â• MASS DATA UPLOAD (Superuser â€” Initial Population & Batch Uploads) â•â•â• */}
      {tab === "massupload" && (
        <div>
          <div style={{ padding: "10px 14px", borderRadius: 6, background: `${B.charcoal}08`, border: `1px solid ${B.charcoal}15`, marginBottom: 14, fontSize: 12, color: B.textSecondary }}>
            <strong>Mass Data Upload</strong> â€” Use this panel to initially populate the HRIS with employee data, or batch-upload records into any module. Files are validated, auto-mapped, and previewed before import. All uploads are logged in the audit trail.
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            {/* Employee Master Data */}
            <Card style={{ borderTop: `4px solid ${B.accent}` }}>
              <SectionTitle>ðŸ‘¥ Employee Master Data</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.teal}` }}>
              <SectionTitle>ðŸ’° Compensation & Payroll</SectionTitle>
            ...
            {/* Leave / Time */}
            <Card style={{ borderTop: `4px solid ${B.blue}` }}>
              <SectionTitle>ðŸ“… Leave & Time Records</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.purple}` }}>
              <SectionTitle>â­ Performance Reviews</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.orange}` }}>
              <SectionTitle>ðŸš€ Onboarding Journeys</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.pink}` }}>
              <SectionTitle>ðŸ“ Survey Results / History</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.dkTeal}` }}>
              <SectionTitle>ðŸ“Š Grant / Project Allocations</SectionTitle>
            ...
            <Card style={{ borderTop: `4px solid ${B.ltPurple}` }}>
              <SectionTitle>ðŸ’³ Allowance Claims (H&W / L&D)</SectionTitle>
              ...
              <Card key={role.id} style={{ marginBottom: 10, borderLeft: `4px solid ${levelColors[role.level] || B.textMuted}` }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: B.textMuted, marginTop: 2 }}>{role.id} Â· {role.users} user(s) assigned</div>
                  </div>
                  <div style={{ display: "flex", gap: 4 }}>
                    <Btn variant="secondary" size="sm" onClick={() => { setEditRole({ ...role }); setShowRoleModal(role.id); }}>âœï¸ Edit</Btn>
                    {!role.locked && <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => { if (role.users === 0) { setSecurityRoles(prev => prev.filter(r => r.id !== role.id)); } else { alert(`Cannot delete "${role.name}" â€” ${role.users} user(s) are still assigned. Reassign them first.`); } }}>ðŸ—‘</Btn>}
                  </div>
                </div>
                <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
          ...
          <Modal open={!!showRoleModal} onClose={() => setShowRoleModal(null)} title={showRoleModal === "new" ? "Create Security Role" : `Edit Role: ${editRole.name}`} width={620}>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                ...
                }}>ðŸ’¾ {showRoleModal === "new" ? "Create Role" : "Save Changes"}</Btn>
              </div>
            </div>
          </Modal>
        </div>
                ...
                <Card key={ent.id} style={{ borderLeft: `4px solid ${typeColors[ent.type] || B.textMuted}` }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: B.textMuted, marginTop: 2 }}>{ent.country} Â· {ent.id}</div>
                    </div>
                  ...
                  <div style={{ display: "flex", gap: 4 }}>
                    <Btn variant="secondary" size="sm" onClick={() => { setEditEntity({ ...ent }); setShowEntityModal(ent.id); }}>âœï¸ Edit</Btn>
                    {ent.headcount === 0 && ent.type !== "HQ" && (
                      <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => { setEntities(prev => prev.filter(e => e.id !== ent.id)); alert(`Entity "${ent.name}" removed`); }}>ðŸ—‘ Remove</Btn>
                    )}
                    {ent.status === "Active" && ent.type !== "HQ" && (
                      <Btn variant="ghost" size="sm" style={{ color: B.warning }} onClick={() => { setEntities(prev => prev.map(e => e.id === ent.id ? { ...e, status: "Inactive" } : e)); alert(`Entity "${ent.name}" deactivated`); }}>â¸ Deactivate</Btn>
                    )}
                    {ent.status === "Inactive" && (
                      <Btn variant="ghost" size="sm" style={{ color: B.success }} onClick={() => { setEntities(prev => prev.map(e => e.id === ent.id ? { ...e, status: "Active" } : e)); }}>â–¶ Reactivate</Btn>
                    )}
                  </div>
                </Card>
              );
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                ...
                <Btn variant="primary" onClick={() => {
                  if (showEntityModal === "new") {
                    setEntities(prev => [...prev, { ...editEntity, id: `ENT-${editEntity.code || Date.now().toString(36)}`, flag: "ðŸ¢", status: "Active", headcount: 0, registrationNo: `NI-${editEntity.code}-${Math.floor(1000 + Math.random() * 9000)}`, established: new Date().toISOString().split("T")[0] }]);
                  } else {
                ...
                }}>ðŸ’¾ {showEntityModal === "new" ? "Create Entity" : "Save Changes"}</Btn>
              </div>
            </div>
          </Modal>
        </div>
      ...
      {/* â•â•â• FORMATTING & DISPLAY â•â•â• */}
      {tab === "formatting" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card>
          ...
          <Card>
            ...
            {[
              ...
              { key: "lang", label: "System Language", options: [{ value: "en", label: "English" }, { value: "fr", label: "FranÃ§ais" }, { value: "es", label: "EspaÃ±ol" }] },
            ...
            <Btn variant="primary" style={{ width: "100%", marginTop: 8 }} onClick={() => alert("Formatting saved and applied globally")}>ðŸ’¾ Save Formatting Changes</Btn>
          </Card>
        </div>
      )}

      {/* â•â•â• USER ADMINISTRATION â•â•â• */}
      {tab === "users" && (
        <Card>
          <SectionTitle action={<Btn variant="primary" size="sm" onClick={() => alert('Add User form â€” enter name, email, role, country, and MFA settings')}>+ Add User</Btn>}>System Users & Access</SectionTitle>
          <Table columns={[
            ...
            { label: "Actions", render: r => (
              <div style={{ display: "flex", gap: 4 }}>
                <Btn variant="ghost" size="sm" onClick={() => alert('Edit user: modify role, permissions, MFA, and country assignment')}>âœï¸</Btn>
                {r.role !== "Superuser" && <Btn variant="ghost" size="sm" style={{ color: B.danger }} onClick={() => alert(`Account locked for ${r.name}. They will be logged out immediately.`)}>ðŸ”’</Btn>}
              </div>
            )},
          ]} data={users} />
        </Card>
          ...
          {users.filter(u => u.status === "Active").map((u, i) => {
            ...
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 700, color: B.textPrimary }}>{u.name}</div>
                  <div style={{ fontSize: 11, color: B.textMuted }}>{u.role} Â· {COUNTRIES.find(c => c.code === u.country)?.flag} {u.ip}</div>
                </div>
                <div style={{ textAlign: "right" }}>
      ...
      <Modal open={!!showConfirm} onClose={() => setShowConfirm(null)} title="Confirm Feature Change" width={450}>
        ...
        <div style={{ padding: 12, borderRadius: 6, background: B.warningBg, border: `1px solid ${B.warning}30`, fontSize: 12, color: B.textPrimary, marginBottom: 16 }}>
          âš ï¸ Feature toggles affect all users globally. Disabling a module will hide it from navigation and prevent access until re-enabled.
        </div>
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
          ...
          <Btn variant={featureToggles[showConfirm] ? "danger" : "success"} onClick={confirmToggle}>
            {featureToggles[showConfirm] ? "ðŸ”’ Disable Feature" : "âœ“ Enable Feature"}
          </Btn>
        </div>
      </Modal>
    </div>
...
const PerformanceModule = ({ employee: empProp } = {}) => {
  ...
  const CYCLES = [
    { id: "2026-H1", name: "H1 2026 Review Cycle", period: "Janâ€“Jun 2026", status: "Active", due: "2026-06-30", completion: 42, selfDone: 14, mgrDone: 8, total: 28 },
    { id: "2025-Annual", name: "2025 Annual Review", period: "Janâ€“Dec 2025", status: "Closed", due: "2026-01-31", completion: 96, selfDone: 27, mgrDone: 26, total: 28 },
    { id: "2025-H1", name: "H1 2025 Mid-Year Check-In", period: "Janâ€“Jun 2025", status: "Closed", due: "2025-07-15", completion: 89, selfDone: 25, mgrDone: 24, total: 28 },
  ];
  ...
  // Feedback wall
  const FEEDBACK = [
    { from: "Sarah Chen", to: "Marcus Johnson", type: "Praise", text: "Outstanding job leading the Nigeria country review â€” your preparation and facilitation were exceptional.", competency: "Leadership", date: "2026-04-20" },
    { from: "Oliver Wright", to: "Sophie Dubois", type: "Coaching", text: "Consider structuring your donor reports with the executive summary first â€” it helps busy readers.", competency: "Communication", date: "2026-04-18" },
    ...
    { from: "Lars MÃ¼ller", to: "David Kim", type: "Coaching", text: "Try breaking the sprint into smaller deliverables â€” it will help the team see progress more clearly.", competency: "Project Management", date: "2026-04-10" },
  ];
  ...
  return (
    <div>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card style={{ borderTop: `4px solid ${B.accent}` }}>
              ...
              {ORG_GOALS.map(g => (
                <div key={g.id} style={{ marginBottom: 10 }}>
                  ...
                  <div style={{ fontSize: 10, color: B.textMuted, marginTop: 2 }}>{g.owner} Â· {g.progress}% complete</div>
                </div>
              ))}
            </Card>
            <Card>
              ...
              {FEEDBACK.slice(0, 4).map((f, i) => (
                <div key={i} style={{ padding: "8px 10px", borderRadius: 6, background: B.bgHover, marginBottom: 6, borderLeft: `3px solid ${feedbackColors[f.type] || B.textMuted}` }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2, fontSize: 12 }}>
                    <Avatar name={f.from} size={20} /><strong>{f.from}</strong><span style={{ color: B.textMuted }}>â†’</span><strong>{f.to}</strong>
                  ...
                  <div style={{ fontSize: 10, color: B.textMuted, marginTop: 2 }}>{f.competency} Â· {fmtDate(f.date)}</div>
                </div>
              ))}
            </Card>
            <Card>
              ...
              {CYCLES.map(c => (
                <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 6, background: c.id === selectedCycle ? B.accentBg : B.bgHover, marginBottom: 4, cursor: "pointer", border: `1px solid ${c.id === selectedCycle ? B.accent : "transparent"}20` }} onClick={() => setSelectedCycle(c.id)}>
                  <div style={{ flex: 1 }}><div style={{ fontSize: 12, fontWeight: 700 }}>{c.name}</div><div style={{ fontSize: 10, color: B.textMuted }}>{c.period} Â· Due {fmtDate(c.due)}</div></div>
            ...
            <Card>
              ...
              {[{ action: "Complete self-assessment", count: activeCycle.total - activeCycle.selfDone, urgency: "High", icon: "ðŸ“" },
                { action: "Manager reviews pending", count: activeCycle.total - activeCycle.mgrDone, urgency: "Medium", icon: "ðŸ‘¥" },
                { action: "Goals at risk (< 50% progress)", count: EMPLOYEE_GOALS.reduce((s, eg) => s + eg.goals.filter(g => g.progress < 50).length, 0), urgency: "High", icon: "ðŸŽ¯" },
                { action: "Development plans needing update", count: 6, urgency: "Low", icon: "ðŸ“š" },
              ].map((a, i) => (
      ...
      {/* â•â•â•â•â•â•â•â• GOALS & OKRs â•â•â•â•â•â•â•â• */}
      {tab === "goals" && (
        <div>
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 6, marginBottom: 14 }}>
            <Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag Excel with Employee ID, Goal Title, Type, Aligned To, Target Date")}>ðŸ“¤ Batch Upload Goals</Btn>
            <Btn variant="primary" size="sm" onClick={() => setShowGoalModal(true)}>+ Create Goal</Btn>
          </div>
          {/* Org goals cascade */}
          <Card style={{ marginBottom: 14, borderTop: `4px solid ${B.accent}` }}>
            <SectionTitle>Goal Alignment Cascade (Organization â†’ Team â†’ Individual)</SectionTitle>
            {ORG_GOALS.map(og => (
          ...
          <Modal open={showGoalModal} onClose={() => setShowGoalModal(false)} title="Create Goal" width={520}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 8 }}>
                ...
                <Btn variant="primary" onClick={() => { alert("Goal created and linked to alignment cascade"); setShowGoalModal(false); }}>âœ“ Create Goal</Btn>
              </div>
            </div>
          </Modal>
        </div>
      ...
      {/* â•â•â•â•â•â•â•â• REVIEW CYCLES â•â•â•â•â•â•â•â• */}
      {tab === "reviews" && (
        <div>
          <div style={{ display: "flex", gap: 10, marginBottom: 14, alignItems: "center" }}>
          ...
          <Card style={{ marginBottom: 14 }}>
            <SectionTitle>Review Status â€” {activeCycle.name}</SectionTitle>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11, fontFamily: "Arial, sans-serif" }}>
                <thead><tr style={{ background: B.bg }}>
      ...
      {/* â•â•â•â•â•â•â•â• FEEDBACK & RECOGNITION â•â•â•â•â•â•â•â• */}
      {tab === "feedback" && (
        <div>
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 6, marginBottom: 14 }}>
            <Btn variant="primary" size="sm" onClick={() => setShowFeedback(true)}>+ Give Feedback</Btn>
            <Btn variant="secondary" size="sm" onClick={() => setShow360(true)}>ðŸ”„ Request 360Â°</Btn>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card style={{ borderTop: `4px solid ${B.success}` }}>
              ...
              {FEEDBACK.map((f, i) => (
                <div key={i} style={{ padding: "10px 12px", borderRadius: 8, background: B.bgHover, marginBottom: 8, borderLeft: `3px solid ${feedbackColors[f.type]}` }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                    ...
                    <span style={{ color: B.textMuted, fontSize: 11 }}>â†’</span>
          ...
          <Modal open={show360} onClose={() => setShow360(false)} title="Request 360Â° Feedback" width={500}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 8 }}><Btn variant="secondary" onClick={() => setShow360(false)}>Cancel</Btn><Btn variant="primary" onClick={() => { alert("360Â° feedback requests sent!"); setShow360(false); }}>ðŸš€ Launch 360Â°</Btn></div>
            </div>
          </Modal>
        </div>
      )}

      {/* â•â•â•â•â•â•â•â• CHECK-INS & 1:1s â•â•â•â•â•â•â•â• */}
      {tab === "checkins" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.blue}` }}>
            ...
            {[{ mgr: "Sarah Chen", emp: "Carlos Rodriguez", date: "2026-04-25", type: "Weekly 1:1", topics: "Q2 deliverables, training plan" },
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                ...
                <div style={{ flex: 1 }}><div style={{ fontSize: 12, fontWeight: 700 }}>{c.mgr} â†” {c.emp}</div><div style={{ fontSize: 11, color: B.textMuted }}>{c.topics}</div></div>
          ...
          <Modal open={showCheckin} onClose={() => setShowCheckin(false)} title="Schedule Check-In" width={450}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}><Btn variant="secondary" onClick={() => setShowCheckin(false)}>Cancel</Btn><Btn variant="primary" onClick={() => { alert("Check-in scheduled! Calendar invite sent."); setShowCheckin(false); }}>ðŸ“… Schedule</Btn></div>
            </div>
          </Modal>
        </div>
      )}

      {/* â•â•â•â•â•â•â•â• TALENT & 9-BOX â•â•â•â•â•â•â•â• */}
      {tab === "talent" && (
        <div>
          <Card style={{ marginBottom: 14 }}>
            <SectionTitle>9-Box Talent Grid (Performance Ã— Potential)</SectionTitle>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card>
              ...
              {[{ range: "4.5â€“5.0 (Exceptional)", count: EMPLOYEE_GOALS.filter(eg => eg.rating >= 4.5).length, color: B.success },
                { range: "4.0â€“4.4 (Exceeds)", count: EMPLOYEE_GOALS.filter(eg => eg.rating >= 4.0 && eg.rating < 4.5).length, color: B.teal },
                { range: "3.5â€“3.9 (Meets+)", count: EMPLOYEE_GOALS.filter(eg => eg.rating >= 3.5 && eg.rating < 4.0).length, color: B.blue },
                { range: "3.0â€“3.4 (Meets)", count: EMPLOYEE_GOALS.filter(eg => eg.rating >= 3.0 && eg.rating < 3.5).length, color: B.warning },
            ...
            <Card>
              ...
              {[{ role: "Country Director â€” Kenya", ready: "Joseph Mwangi", developing: "Grace Okafor" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.accent}` }}>
            ...
            {DEPARTMENTS.slice(0, 7).map(d => {
              ...
              const avg = emps.length ? (emps.reduce((s, eg) => s + eg.rating, 0) / emps.length).toFixed(1) : "â€”";
              return (<div key={d} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                ...
                <div style={{ flex: 1 }}><ProgressBar value={avg !== "â€”" ? parseFloat(avg) : 0} max={5} color={avg >= 4 ? B.success : avg >= 3.5 ? B.blue : B.warning} /></div>
                <span style={{ fontSize: 12, fontWeight: 700, width: 28, textAlign: "right" }}>{avg}</span>
              </div>);
            })}
          </Card>
          <Card>
            ...
            {["Performance", "Development"].map(type => {
              ...
              return (<div key={type} style={{ marginBottom: 10 }}>
                ...
                <div style={{ fontSize: 10, color: B.textMuted, marginTop: 2 }}>{goals.length} goals Â· {goals.filter(g => g.status === "On Track").length} on track Â· {goals.filter(g => g.status === "At Risk").length} at risk</div>
              </div>);
            })}
          </Card>
          <Card>
...
const LMSModule = ({ employee: empProp } = {}) => {
  ...
  return (
    <div>
      ...
      {/* â•â•â•â•â•â•â•â• LMS DASHBOARD â•â•â•â•â•â•â•â• */}
      {tab === "dashboard" && (
        <div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(155px,1fr))", gap: 10, marginBottom: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card style={{ borderTop: `4px solid ${B.accent}` }}>
              ...
              {LEARNING_PATHS.slice(0, 6).map((p, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 11, color: B.textMuted }}>{p.courses} courses Â· {p.hours}</span>
            ...
            <Card>
              ...
              <div style={{ marginTop: 10, padding: 10, borderRadius: 6, background: B.dangerBg, border: `1px solid ${B.danger}20`, fontSize: 12 }}>
                <strong style={{ color: B.danger }}>4 employees</strong> have overdue mandatory training. <Btn variant="ghost" size="sm" style={{ color: B.danger }}onClick={() => alert('Reminder emails sent to 4 employees with overdue mandatory training')}>Send Reminders â†’</Btn>
              </div>
            </Card>
            <Card>
              ...
              {[...COURSES].sort((a, b) => b.rating - a.rating).slice(0, 5).map((c, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: `1px solid ${B.borderLight}`, fontSize: 12 }}>
                  ...
                  <span style={{ fontWeight: 700, color: B.orange }}>â˜… {c.rating}</span>
                </div>
              ))}
            </Card>
            <Card>
      ...
      {/* â•â•â•â•â•â•â•â• COURSE CATALOG â•â•â•â•â•â•â•â• */}
      {tab === "catalog" && (
        <div>
          <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
            ...
            <Btn variant="secondary" size="sm" onClick={() => alert("Batch upload: drag SCORM package or Excel course list")}>ðŸ“¤ Import Courses</Btn>
          </div>
            ...
            {filtered.map(c => (
              <Card key={c.id} style={{ borderLeft: `4px solid ${catColors[c.cat] || B.accent}`, cursor: "pointer" }} onClick={() => setSelectedCourse(c)}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  ...
                  <span style={{ fontSize: 11, color: B.orange, fontWeight: 700 }}>â˜… {c.rating}</span>
                </div>
                <div style={{ fontSize: 14, fontWeight: 700, color: B.textPrimary, marginBottom: 2 }}>{c.title}</div>
                <div style={{ fontSize: 11, color: B.textMuted, marginBottom: 6 }}>{c.provider} Â· {c.duration} Â· {c.language.join(", ")} Â· {c.competency}</div>
          ...
          <Modal open={!!selectedCourse} onClose={() => setSelectedCourse(null)} title={selectedCourse?.title || ""} width={600}>
            {selectedCourse && (() => { const c = selectedCourse; return (<div>
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 14 }}>
                ...
                <div style={{ flex: 1, textAlign: "center", padding: 12, borderRadius: 8, background: B.bgHover }}><div style={{ fontSize: 20, fontWeight: 700, fontFamily: "Georgia, serif", color: B.orange }}>â˜… {c.rating}</div><div style={{ fontSize: 10, color: B.textMuted }}>Rating</div></div>
              </div>
              <div style={{ display: "flex", gap: 8 }}><Btn variant="primary" style={{ flex: 1 }}onClick={() => alert('Launching course: ' + c.title)}>â–¶ Launch Course</Btn><Btn variant="secondary" onClick={() => alert('Assign course to staff â€” select employees, departments, or all staff')}>ðŸ“‹ Assign to Staff</Btn><Btn variant="secondary" onClick={() => alert('Course analytics: enrollment, completion rates, avg score, and feedback')}>ðŸ“Š View Report</Btn></div>
            </div>); })()}
          </Modal>
        </div>
      )}

      {/* â•â•â•â•â•â•â•â• LEARNING PATHS â•â•â•â•â•â•â•â• */}
      {tab === "paths" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {LEARNING_PATHS.map((p, i) => (
            <Card key={i} style={{ borderLeft: `4px solid ${p.color}` }}>
              ...
              <div style={{ fontSize: 12, color: B.textMuted, marginBottom: 8 }}>{p.audience} Â· {p.courses} courses Â· {p.hours}</div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
              ...
              <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
                {COURSES.filter(c => c.path === p.name).map(c => (
                  <Badge key={c.id} color={catColors[c.cat] || B.textMuted} bg={`${catColors[c.cat] || B.textMuted}08`} style={{ fontSize: 9, textTransform: "none" }}>{c.title.length > 30 ? c.title.slice(0, 30) + "â€¦" : c.title}</Badge>
                ))}
              </div>
            </Card>
          ))}
      ...
      {/* â•â•â•â•â•â•â•â• COMPLIANCE TRACKER â•â•â•â•â•â•â•â• */}
      {tab === "compliance" && (
        <Card>
                  ...
                  <tr key={ei} onMouseEnter={ev => ev.currentTarget.style.background = B.bgHover} onMouseLeave={ev => ev.currentTarget.style.background = "transparent"}>
                    ...
                    {statuses.map((s, si) => (
                      <td key={si} style={{ padding: "6px 6px", textAlign: "center", borderBottom: `1px solid ${B.borderLight}` }}>
                        <div style={{ width: 20, height: 20, borderRadius: 10, background: s === "done" ? B.success : s === "progress" ? B.warning : B.danger, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#fff" }}>{s === "done" ? "âœ“" : s === "progress" ? "â—" : "!"}</div>
                      </td>
                    ))}
      ...
      {/* â•â•â•â•â•â•â•â• EVENTS & WEBINARS â•â•â•â•â•â•â•â• */}
      {tab === "events" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {[{ title: "Quarterly L&D Town Hall", date: "2026-05-08", time: "14:00 UTC", type: "Webinar", speaker: "VP People & Culture", registered: 24, capacity: 50, status: "Upcoming" },
            ...
            { title: "Leadership Coaching Circle â€” Cohort 3", date: "2026-06-01", time: "16:00 UTC", type: "Community", speaker: "External Coach", registered: 6, capacity: 8, status: "Upcoming" },
            ...
            { title: "New Hire Orientation â€” April Cohort", date: "2026-04-07", time: "09:00 EST", type: "Orientation", speaker: "People & Culture", registered: 3, capacity: 10, status: "Completed" },
          ].map((ev, i) => (
            <Card key={i} style={{ borderLeft: `4px solid ${ev.status === "Upcoming" ? B.blue : B.textMuted}` }}>
              ...
              <div style={{ fontSize: 12, color: B.textMuted, marginBottom: 6 }}>{fmtDate(ev.date)} Â· {ev.time} Â· {ev.speaker}</div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12 }}>
              ...
              {ev.status === "Upcoming" && <Btn variant="primary" size="sm" style={{ width: "100%", marginTop: 8 }}onClick={() => alert('Registered! Calendar invite sent to your email.')}>ðŸ“… Register / Add to Calendar</Btn>}
            </Card>
          ))}
        </div>
      )}

      {/* â•â•â•â•â•â•â•â• ANALYTICS & IMPACT â•â•â•â•â•â•â•â• */}
      {tab === "analytics" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.accent}` }}>
      ...
      {/* â•â•â•â•â•â•â•â• LMS ADMIN â•â•â•â•â•â•â•â• */}
      {tab === "admin" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card>
            <SectionTitle>System Configuration</SectionTitle>
            {[{ l: "SSO Provider", v: "Azure AD (SAML 2.0)", s: "Connected" },
              { l: "HRIS Integration", v: "NI-HRIS â†” LMS auto-sync", s: "Active" },
          ...
          <Card>
            ...
            {[{ portal: "Staff Learning Hub", audience: "All NI Employees", users: 28, brand: "NI Brand", status: "Active" },
              ...
              <div key={i} style={{ padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                ...
                <div style={{ fontSize: 11, color: B.textMuted }}>{p.audience} Â· {p.users} users Â· Theme: {p.brand}</div>
              </div>
            ))}
          </Card>
          <Card style={{ gridColumn: "1 / -1" }}>
...
// â”€â”€â”€ PREBOARDING & ONBOARDING MODULE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const OnboardingModule = () => {
  ...
  const JOURNEYS = [
    ...
    { id: "ONB-2026-011", name: "Daniel Osei", role: "Program Officer â€” Fortification", country: "KE", dept: "Programs", manager: "Sarah Chen", startDate: "2026-04-28", phase: "Week 1", status: "In Progress", progress: 40, template: "Field Staff", buddy: "Joseph Mwangi", offer: "2026-03-25", tasks: { total: 28, done: 11, overdue: 0 } },
    ...
    { id: "ONB-2025-042", name: "James Kamau", role: "IT Support Specialist", country: "KE", dept: "IT & Digital", manager: "Lars MÃ¼ller", startDate: "2025-10-01", phase: "Complete", status: "Complete", progress: 100, template: "Standard HQ", buddy: "David Kim", offer: "2025-08-20", tasks: { total: 24, done: 24, overdue: 0 } },
  ];

  const PREBOARD_TASKS = [
    { cat: "Documents & Compliance", icon: "ðŸ“‹", tasks: [
    ...
    { cat: "IT & Access Provisioning", icon: "ðŸ’»", tasks: [
    ...
    { cat: "Communication & Engagement", icon: "ðŸ’¬", tasks: [
    ...
    { cat: "Culture & Content", icon: "ðŸŒ", tasks: [
  ...
  const ONBOARD_PHASES = [
    ...
    { phase: "6â€“12 Months", color: B.grey, tasks: ["6-month check-in with manager", "Career development plan initiated", "Join relevant communities of practice", "Submit 6-month engagement survey", "12-month anniversary recognition", "Full onboarding journey marked complete"] },
  ];

  const TEMPLATES = [
    { name: "National â€” Open Ended (HQ)", category: "NAT", modality: "OE", countries: "CA, GB, CH, IT", roles: "All HQ permanent roles", phases: 6, tasks: 26, desc: "Full onboarding for permanent national staff at headquarters", color: B.accent },
    { name: "National â€” Fixed Term", category: "NAT", modality: "FT", countries: "All entity countries", roles: "Project-specific, seasonal", phases: 4, tasks: 20, desc: "Streamlined onboarding for fixed-term national staff (3â€“12 months)", color: B.blue },
  ...
  const getMyTasks = (journey) => {
    ...
    const onb = ph !== "Pre-boarding" ? [
      { name: "Complete safeguarding & code of conduct training", status: ph === "Week 1" ? "progress" : "done", cat: "Learning", icon: "ðŸ“š", due: "Day 1", owner: "New Hire" },
      { name: "Set up all tools & confirm access working", status: ph === "Week 1" ? "progress" : "done", cat: "IT", icon: "ðŸ’»", due: "Week 1", owner: "New Hire" },
      { name: "Complete role-specific learning path", status: ["30-Day","60-Day","90-Day"].includes(ph) ? "progress" : ph === "Week 1" ? "pending" : "done", cat: "Learning", icon: "ðŸ“š", due: "30 Days", owner: "New Hire" },
      { name: "Submit 30-day pulse survey", status: ["60-Day","90-Day"].includes(ph) ? "done" : ph === "30-Day" ? "progress" : "pending", cat: "Feedback", icon: "ðŸ“", due: "30 Days", owner: "New Hire" },
      { name: "Begin first project / deliverable", status: ["60-Day","90-Day"].includes(ph) ? "progress" : "pending", cat: "Work", icon: "ðŸŽ¯", due: "60 Days", owner: "New Hire" },
      { name: "Submit 90-day NPS survey", status: ph === "90-Day" ? "progress" : "pending", cat: "Feedback", icon: "ðŸ“", due: "90 Days", owner: "New Hire" },
    ] : [];
    return [...pre, ...onb];
  };
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, padding: "8px 14px", borderRadius: 8, background: viewAs !== "admin" ? `linear-gradient(135deg, ${B.charcoal}, ${B.grey})` : B.bgHover, border: `1px solid ${viewAs !== "admin" ? B.charcoal : B.border}` }}>
        <span style={{ fontSize: 14 }}>{viewAs === "admin" ? "âš™ï¸" : "ðŸ‘¤"}</span>
        ...
        <Select value={viewAs} onChange={handleViewAs} style={{ fontSize: 12, background: viewAs !== "admin" ? B.grey : B.white, color: viewAs !== "admin" ? "#fff" : B.textPrimary, borderColor: viewAs !== "admin" ? B.grey : B.border, minWidth: 240 }}
          options={[{ value: "admin", label: "âš™ï¸ HR Admin / Manager View" }, ...activeJourneys.map(j => ({ value: j.id, label: `ðŸ‘¤ ${j.name} â€” ${j.role} (${j.phase})` }))]} />
        {viewAs !== "admin" && <Badge color={B.yellow} bg="rgba(255,184,28,0.25)" style={{ color: "#fff" }}>EMPLOYEE PREVIEW</Badge>}
      </div>

      {/* â•â•â• EMPLOYEE PORTAL VIEW â•â•â• */}
      {viewAs !== "admin" && viewAsJourney && (() => {
        ...
        return (<div>
          ...
          <Card style={{ marginBottom: 14, background: `linear-gradient(135deg, ${B.charcoal}, ${B.grey})`, color: "#fff", border: "none", overflow: "hidden", padding: 24, position: "relative" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, opacity: 0.85, marginTop: 4 }}>{j.role} Â· {j.dept} Â· {c?.flag} {c?.name}</div>
                <div style={{ fontSize: 12, opacity: 0.7, marginTop: 2 }}>Manager: {j.manager} Â· Buddy: {j.buddy}</div>
              </div>
            ...
            <div style={{ marginTop: 14, padding: "10px 16px", borderRadius: 8, background: "rgba(255,255,255,0.08)", fontSize: 12, opacity: 0.9, lineHeight: 1.7 }}>
              {isPreboard ? "Complete the tasks below before your start date so you're ready for day one. Your manager and buddy are expecting to hear from you â€” don't hesitate to reach out!" : `You're in your ${j.phase} phase â€” keep up the great progress! Reach out to ${j.buddy} or ${j.manager} anytime.`}
            </div>
          </Card>
          {/* Progress + Contacts */}
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 14, marginBottom: 14 }}>
            <Card style={{ borderTop: `4px solid ${phaseColors[j.phase] || B.accent}` }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 14 }}>
                ...
                <div><div style={{ fontSize: 14, fontWeight: 700 }}>Phase: <span style={{ color: phaseColors[j.phase] }}>{j.phase}</span></div><div style={{ fontSize: 12, color: B.textMuted }}>{doneTasks}/{myTasks.length} personal tasks Â· Template: {j.template}</div></div>
              </div>
          ...
          <Card style={{ marginBottom: 14 }}>
            ...
            {myTasks.map((t, ti) => (
              <div key={ti} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 10px", borderRadius: 6, marginBottom: 3, background: t.status === "done" ? B.successBg : t.status === "progress" ? B.warningBg : B.bgHover, border: `1px solid ${t.status === "done" ? `${B.success}15` : t.status === "progress" ? `${B.warning}15` : B.borderLight}` }}>
                <div style={{ width: 20, height: 20, borderRadius: 10, border: `2px solid ${t.status === "done" ? B.success : t.status === "progress" ? B.warning : B.border}`, background: t.status === "done" ? B.success : "transparent", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#fff", flexShrink: 0 }}>{t.status === "done" ? "âœ“" : ""}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card>
              <SectionTitle>ðŸ“š Welcome Content</SectionTitle>
              {[{ t: "Our Mission: Nourish Life", type: "Video Â· 4 min", icon: "ðŸŽ¬", done: true },
                { t: "NI Values & Culture", type: "Video Â· 6 min", icon: "ðŸŽ¬", done: false },
                { t: "Employee Handbook 2026", type: "PDF Â· 45 pages", icon: "ðŸ“„", done: false },
                { t: `Benefits Guide â€” ${c?.name}`, type: "Guide Â· 12 pages", icon: "ðŸ“‹", done: false },
                { t: "Safeguarding Training", type: "E-learning Â· 30 min", icon: "ðŸ›¡ï¸", done: false },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 10px", borderRadius: 6, background: B.bgHover, marginBottom: 3, cursor: "pointer" }}
                  ...
                  {item.done ? <Badge color={B.success} bg={B.successBg} style={{ fontSize: 8 }}>Done</Badge> : <span style={{ color: B.accent, fontSize: 11, fontWeight: 700, cursor: "pointer" }} onClick={() => alert(`Opening: ${item.t}`)}>Open â†’</span>}
                </div>
              ))}
            </Card>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <Card>
                <SectionTitle>â“ FAQ</SectionTitle>
                {[{ q: "How do I enroll in benefits?", a: "Visit Benefits tab after start date, or contact People & Culture." },
                  ...
                  { q: "How does flexible work operate?", a: "Check with your manager â€” NI supports hybrid arrangements." },
              ...
              <Card>
                <SectionTitle>ðŸŽ¯ How are you feeling?</SectionTitle>
                <div style={{ display: "flex", gap: 8, justifyContent: "center", margin: "8px 0" }}>
                  {["ðŸ˜Ÿ","ðŸ˜","ðŸ™‚","ðŸ˜Š","ðŸ¤©"].map((em, i) => (
      ...
      {/* â•â•â• ADMIN VIEW (existing tabs) â•â•â• */}
      {viewAs === "admin" && (<>
      <Tabs tabs={[
      ...
      {tab === "dashboard" && (
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Card style={{ borderTop: `4px solid ${B.accent}` }}>
              <SectionTitle action={<div style={{display:"flex",gap:6}}><Btn variant="secondary" size="sm" onClick={()=>alert("Batch upload: drag Excel with Name, Role, Country, Dept, Start Date, Manager, Template columns")}>ðŸ“¤ Batch Upload</Btn><Btn variant="primary" size="sm" onClick={() => setShowNewHire(true)}>+ New Hire</Btn></div>}>Active New Hires</SectionTitle>
              {JOURNEYS.filter(j => j.status !== "Complete").map(j => (
                <div key={j.id} onClick={() => { setSelectedJourney(j); setTab("preboard"); }} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6, cursor: "pointer", border: `1px solid ${B.border}` }}
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: B.textMuted }}>{j.role} Â· {COUNTRIES.find(c => c.code === j.country)?.flag} {j.country} Â· Starts {fmtDate(j.startDate)}</div>
                  </div>
              ...
              <Card>
                ...
                {JOURNEYS.filter(j => j.tasks.overdue > 0).map(j => (
                  <div key={j.id} style={{ padding: "8px 12px", borderRadius: 6, background: B.dangerBg, border: `1px solid ${B.danger}20`, marginBottom: 6 }}>
                    ...
                    <div style={{ fontSize: 11, color: B.textMuted, marginTop: 2 }}>{j.role} Â· Phase: {j.phase}</div>
                  </div>
                ))}
                {JOURNEYS.every(j => j.tasks.overdue === 0) && <div style={{ textAlign: "center", padding: 12, fontSize: 12, color: B.success }}>âœ… No overdue tasks</div>}
              </Card>
            </div>
          </div>
          {/* New Hire Modal */}
          <Modal open={showNewHire} onClose={() => setShowNewHire(false)} title="Initiate New Hire Onboarding" width={580}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 6 }}>
                ...
                <Btn variant="primary" onClick={() => { alert("Onboarding journey initiated! Welcome email & pre-boarding tasks generated."); setShowNewHire(false); }}>ðŸš€ Launch Pre-boarding</Btn>
              </div>
            </div>
          </Modal>
        </div>
      ...
      {/* â•â•â•â•â•â•â•â• ACTIVE JOURNEYS â•â•â•â•â•â•â•â• */}
      {tab === "journeys" && (
        <div>
          {JOURNEYS.map(j => (
            <Card key={j.id} style={{ marginBottom: 10, borderLeft: `4px solid ${phaseColors[j.phase] || B.textMuted}` }}>
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: B.textSecondary }}>{j.role} Â· {j.dept} Â· {COUNTRIES.find(c => c.code === j.country)?.flag} {j.country}</div>
                  <div style={{ fontSize: 11, color: B.textMuted }}>Manager: {j.manager} Â· Buddy: {j.buddy} Â· Template: {j.template}</div>
                  <div style={{ fontSize: 11, color: B.textMuted }}>Offer: {fmtDate(j.offer)} Â· Start: {fmtDate(j.startDate)}</div>
                </div>
                <div style={{ width: 100, textAlign: "center", flexShrink: 0 }}>
                  ...
                  <div style={{ fontSize: 10, color: B.textMuted, marginTop: 3 }}>{j.tasks.done}/{j.tasks.total} tasks{j.tasks.overdue > 0 ? ` Â· ${j.tasks.overdue} overdue` : ""}</div>
                </div>
              </div>
            </Card>
          ))}
      ...
      {/* â•â•â•â•â•â•â•â• PRE-BOARDING CHECKLIST â•â•â•â•â•â•â•â• */}
      {tab === "preboard" && (
        <div>
          <div style={{ padding: "10px 14px", borderRadius: 6, background: B.warningBg, border: `1px solid ${B.warning}30`, marginBottom: 14, fontSize: 12 }}>
            <strong>Pre-boarding Checklist</strong> â€” Showing tasks for <strong>{selectedJourney?.name || "Maria Santos"}</strong> starting {fmtDate(selectedJourney?.startDate || "2026-05-05")}. Tasks are auto-assigned to HR, IT, Manager, Buddy, and the new hire.
          </div>
      ...
      {/* â•â•â•â•â•â•â•â• ONBOARDING PHASES â•â•â•â•â•â•â•â• */}
      {tab === "phases" && (
        <div>
      ...
      {/* â•â•â•â•â•â•â•â• JOURNEY TEMPLATES (by NI Classification) â•â•â•â•â•â•â•â• */}
      {tab === "templates" && (
        <div>
          ...
          {TEMPLATES.map((t, i) => {
            ...
            <Card key={i} style={{ borderLeft: `4px solid ${t.color || B.accent}` }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", fontSize: 11, color: B.textMuted }}>
                <span>ðŸŒ {t.countries}</span><span>Â·</span><span>ðŸ‘¤ {t.roles}</span><span>Â·</span>
                <span>ðŸ“Š {t.phases} phases</span><span>Â·</span><span>âœ… {t.tasks} tasks</span>
              </div>
              <Btn variant="secondary" size="sm" style={{ marginTop: 8, width: "100%" }} onClick={() => alert("Template editor: modify phases, tasks, owners, and due dates for this journey template")}>âœï¸ Edit Template</Btn>
            </Card>);
          })}
          </div>
        </div>
      ...
      {/* â•â•â•â•â•â•â•â• PULSE SURVEYS â•â•â•â•â•â•â•â• */}
      {tab === "surveys" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ borderTop: `4px solid ${B.teal}` }}>
            ...
            {[{ timing: "End of Week 1", questions: 3, focus: "First impressions, setup experience, team welcome", response: "85%" },
              ...
              <div key={i} style={{ padding: "10px 12px", borderRadius: 6, background: B.bgHover, marginBottom: 6 }}>
                ...
                <div style={{ fontSize: 11, color: B.textMuted }}>{s.questions} questions Â· {s.focus}</div>
              </div>
            ))}
          </Card>
          <Card>
      ...
      {tab === "analytics" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          ...
          <Card>
            ...
            <div style={{ fontSize: 11, color: B.textMuted, marginTop: 8, textAlign: "center" }}>Avg satisfaction score across all pulse check-ins (1â€“5 scale)</div>
          </Card>
        </div>
      )}
      </>)}
...
// â”€â”€â”€ ORG CHART MODULE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div style={{ marginLeft: isRoot ? 0 : 28 }}>
        <div onClick={() => setSelectedEmployee(emp)}
          ...
          <div style={{ textAlign: "right", flexShrink: 0 }}>
            ...
            <div style={{ fontSize: 10, color: B.textMuted }}>{emp.department} Â· {emp.level}</div>
          </div>
          {reports.length > 0 && (
  ...
  const GridCard = ({ emp }) => {
    ...
    return (
      <div onClick={() => setSelectedEmployee(emp)} style={{ padding: 14, borderRadius: 8, border: `1px solid ${highlightId === emp.id ? B.accent : B.border}`, background: highlightId === emp.id ? B.accentBg : B.white, cursor: "pointer", transition: "all 0.2s", boxShadow: highlightId === emp.id ? `0 0 0 2px ${B.accent}40` : "none" }}
        ...
        <div style={{ fontSize: 11, color: B.textMuted, marginBottom: 6 }}>{emp.department} Â· {emp.level}</div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap", alignItems: "center" }}>
              ...
              {searchResults.slice(0, 8).map(emp => (
                <div key={emp.id} onClick={() => handleSearchSelect(emp)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", cursor: "pointer", borderBottom: `1px solid ${B.borderLight}` }}
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 10, color: B.textMuted }}>{emp.title} Â· {emp.department}</div>
                  </div>
        ...
        <div style={{ display: "flex", gap: 2, background: B.bgHover, borderRadius: 6, padding: 2, border: `1px solid ${B.border}` }}>
          {[{ k: "tree", l: "ðŸŒ³ Tree" }, { k: "grid", l: "â–¦ Grid" }].map(v => (
        ...
        <div style={{ display: "flex", gap: 4 }}>
          ...
          <Btn variant="primary" size="sm" onClick={() => setShowExport(true)}>â¬‡ Export</Btn>
        </div>
      </div>
      ...
      {viewMode === "tree" && (
        <div>
          ...
          <Card style={{ marginBottom: 10, padding: 14, borderTop: `4px solid ${B.accent}`, textAlign: "center" }}>
            ...
            <div style={{ fontSize: 11, color: B.textMuted }}>Global Organization Structure Â· {EMPLOYEES.length} employees Â· {COUNTRIES.length} countries</div>
          </Card>
      ...
      <Modal open={showExport} onClose={() => setShowExport(false)} title="Export Org Chart" width={500}>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              {[{ v: "pdf", l: "PDF", icon: "ðŸ“„", desc: "Best for sharing and printing" },
                { v: "pptx", l: "PowerPoint", icon: "ðŸ“Š", desc: "Editable slides for presentations" },
                { v: "docx", l: "Word", icon: "ðŸ“", desc: "Editable document with org table" },
                { v: "vsdx", l: "Visio", icon: "ðŸ”·", desc: "Editable diagram for restructuring" },
              ].map(f => (
          ...
          <div style={{ padding: 10, borderRadius: 6, background: B.bgHover, border: `1px solid ${B.border}`, fontSize: 12, color: B.textSecondary }}>
            <strong>Export preview:</strong> {exportScope === "full" ? `Full organization (${EMPLOYEES.length} people, ${COUNTRIES.length} countries)` : exportScope === "current" ? `Current filtered view (${allFiltered.length} people)` : exportScope === "department" ? `${exportDept} department (${EMPLOYEES.filter(e => e.department === exportDept).length} people)` : `${COUNTRIES.find(c => c.code === filterCountry)?.name || "Selected country"}`} â†’ .{exportFormat} file
          </div>
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
            <Btn variant="secondary" onClick={() => setShowExport(false)}>Cancel</Btn>
            <Btn variant="primary" onClick={() => { alert(`Org chart exported as ${exportFormat.toUpperCase()} (${exportScope})`); setShowExport(false); }}>â¬‡ Download .{exportFormat}</Btn>
          </div>
        </div>
      </Modal>
    </div>
...
// â”€â”€â”€ NI BRANDED ICON SYSTEM (Circle-Square Motif) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const ROLE_META = {
  employee:  { label: "Employee",  icon: "ðŸ‘¤", color: B.teal },
  manager:   { label: "Manager",   icon: "ðŸ‘¥", color: B.blue },
  hr:        { label: "HR Admin",  icon: "âš™ï¸", color: B.orange },
  superuser: { label: "Superuser", icon: "ðŸ”", color: B.yellow },
};
    ...
    <div style={{ display: "flex", height: "100vh", background: B.bg, fontFamily: "Arial, Helvetica, sans-serif", color: B.textPrimary, overflow: "hidden", position: "relative" }}>
      ...
      {!isMobile && (
        <div style={{ width: sidebarW, background: B.charcoal, display: "flex", flexDirection: "column", transition: "width 0.2s ease", overflow: "hidden", flexShrink: 0, position: "relative" }}>
          ...
          {/* Role Picker â€” custom styled dropdown */}
          {sidebarOpen && (
            <div style={{ padding: "8px 10px", borderTop: `1px solid ${B.grey}`, position: "relative" }}>
              ...
              {/* Current role button â€” triggers picker */}
        ...
        <div style={{ height: 50, borderBottom: `1px solid ${B.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px", background: B.white, flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ display: "flex", gap: 1, background: B.bgHover, borderRadius: 6, padding: 2, border: `1px solid ${B.border}` }}>
              {[{ key: "desktop", label: "ðŸ–¥ï¸" }, { key: "tablet", label: "ðŸ“±" }, { key: "mobile", label: "ðŸ“²" }].map(v => (
